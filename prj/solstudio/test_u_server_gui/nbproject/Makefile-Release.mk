...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/test_u_server_gui

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/test_u_server_gui: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/test_u_server_gui ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/1385395607/net_callbacks.o: ../../../test_u/net_callbacks.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1385395607
	$(COMPILE.cc) -fast -g0 -o ${OBJECTDIR}/_ext/1385395607/net_callbacks.o ../../../test_u/net_callbacks.cpp
...
${OBJECTDIR}/_ext/1385395607/net_server.o: ../../../test_u/net_server.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1385395607
	$(COMPILE.cc) -fast -g0 -o ${OBJECTDIR}/_ext/1385395607/net_server.o ../../../test_u/net_server.cpp

${OBJECTDIR}/_ext/1385395607/net_server_signalhandler.o: ../../../test_u/net_server_signalhandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1385395607
	$(COMPILE.cc) -fast -g0 -o ${OBJECTDIR}/_ext/1385395607/net_server_signalhandler.o ../../../test_u/net_server_signalhandler.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/test_u_server_gui
	${CCADMIN} -clean
