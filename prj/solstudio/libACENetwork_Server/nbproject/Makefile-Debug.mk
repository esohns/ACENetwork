...
${OBJECTDIR}/_ext/576663459/net_server_asynchlistener.o: ../../../src/client_server/net_server_asynchlistener.cpp 
	...
	$(COMPILE.cc) -g -KPIC  -o ${OBJECTDIR}/_ext/576663459/net_server_asynchlistener.o ../../../src/client_server/net_server_asynchlistener.cpp

${OBJECTDIR}/_ext/576663459/net_server_common_tools.o: ../../../src/client_server/net_server_common_tools.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/576663459
	$(COMPILE.cc) -g -KPIC  -o ${OBJECTDIR}/_ext/576663459/net_server_common_tools.o ../../../src/client_server/net_server_common_tools.cpp

${OBJECTDIR}/_ext/576663459/net_server_listener.o: ../../../src/client_server/net_server_listener.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/576663459
	$(COMPILE.cc) -g -KPIC  -o ${OBJECTDIR}/_ext/576663459/net_server_listener.o ../../../src/client_server/net_server_listener.cpp
