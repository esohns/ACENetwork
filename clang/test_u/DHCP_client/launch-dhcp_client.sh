#!/bin/sh
bindir=$(pwd)
cd /mnt/win_d/projects/ACENetwork/clang/../test_u/DHCP_client
...
if test "x$1" = "x--debugger"; then
	...
	if test "xYES" = "xYES"; then
		...
		/usr/bin/gdb -batch -command=$bindir/gdbscript --return-child-result /mnt/win_d/projects/ACENetwork/clang/test_u/DHCP_client/dhcp_client 
	else
		"/mnt/win_d/projects/ACENetwork/clang/test_u/DHCP_client/dhcp_client" -l -t 
	fi
else
	"/mnt/win_d/projects/ACENetwork/clang/test_u/DHCP_client/dhcp_client" -l -t 
fi
