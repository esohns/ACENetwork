...
if test "x$1" = "x--debugger"; then
	...
	if test "xYES" = "xYES"; then
		...
		/usr/bin/gdb -batch -command=$bindir/gdbscript --return-child-result /mnt/win_d/projects/ACENetwork/clang/test_i/IRC_client/IRC_client 
	else
		"/mnt/win_d/projects/ACENetwork/clang/test_i/IRC_client/IRC_client" -l -t 
	fi
else
	"/mnt/win_d/projects/ACENetwork/clang/test_i/IRC_client/IRC_client" -l -t 
fi
