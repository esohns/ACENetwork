...
typedef Net_StreamTCPSocketBase_T<Net_TCPSocketHandler_T<BitTorrent_Client_SocketHandlerConfiguration,
                                                         ACE_SOCK_STREAM>,
                                  ACE_INET_Addr,
                                  ...
                                  BitTorrent_Client_ModuleHandlerConfiguration> BitTorrent_Client_TCPHandler_t;
typedef Net_StreamAsynchTCPSocketBase_T<Net_AsynchTCPSocketHandler_T<BitTorrent_Client_SocketHandlerConfiguration>,
                                        ACE_INET_Addr,
                                        BitTorrent_Client_Configuration,
                                        BitTorrent_Client_SessionState,
                                        IRC_RuntimeStatistic_t,
                                        ...
                                        BitTorrent_Client_UserData,
                                        Stream_ModuleConfiguration,
                                        BitTorrent_Client_ModuleHandlerConfiguration> BitTorrent_Client_AsynchTCPHandler_t;
typedef Net_TCPConnectionBase_T<BitTorrent_Client_TCPHandler_t,
                                ...
                                BitTorrent_Client_UserData> BitTorrent_Client_TCPConnection_t;
typedef Net_AsynchTCPConnectionBase_T<BitTorrent_Client_AsynchTCPHandler_t,
                                      ...
                                      BitTorrent_Client_Stream,
                                      BitTorrent_Client_SocketHandlerConfiguration,
                                      BitTorrent_Client_UserData> BitTorrent_Client_AsynchTCPConnection_t;
...
typedef Net_IConnection_T<ACE_INET_Addr,
                          BitTorrent_Client_Configuration,
                          BitTorrent_Client_SessionState,
                          IRC_RuntimeStatistic_t> BitTorrent_Client_IConnection_t;
typedef Net_ISocketConnection_T<ACE_INET_Addr,
                                ...
                                BitTorrent_Client_SocketHandlerConfiguration> BitTorrent_Client_ISocketConnection_t;
...
typedef Net_Connection_Manager_T<ACE_INET_Addr,
                                 ...
                                 BitTorrent_Client_SessionState,
                                 IRC_RuntimeStatistic_t,
                                 BitTorrent_Client_UserData> BitTorrent_Client_Connection_Manager_t;
