...
//void
//BitTorrent_Client_Tools::parseConfigurationFile (const std::string& fileName_in,
//                                                 IRC_LoginOptions& loginOptions_out,
//                                                 BitTorrent_Client_Connections_t& connections_out)
//{
//  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Client_Tools::parseConfigurationFile"));
...
//                                     ACE_TEXT (BitTorrent_Client_CNF_LOGIN_SECTION_HEADER),
//                                     0, // MUST exist !
//                                     section_key);
//  if (result == -1)
//  {
...
//    if (item_name == ACE_TEXT_ALWAYS_CHAR (BitTorrent_Client_CNF_PASSWORD_LABEL))
//      loginOptions_out.passWord = ACE_TEXT_ALWAYS_CHAR (item_value.c_str ());
//    else if (item_name == ACE_TEXT_ALWAYS_CHAR (BitTorrent_Client_CNF_NICKNAME_LABEL))
//      loginOptions_out.nickName = ACE_TEXT_ALWAYS_CHAR (item_value.c_str ());
//    else if (item_name == ACE_TEXT_ALWAYS_CHAR (BitTorrent_Client_CNF_USER_LABEL))
//      loginOptions_out.user.userName =
//          ACE_TEXT_ALWAYS_CHAR (item_value.c_str ());
//    else if (item_name == ACE_TEXT_ALWAYS_CHAR (BitTorrent_Client_CNF_REALNAME_LABEL))
//      loginOptions_out.user.realName =
//          ACE_TEXT_ALWAYS_CHAR (item_value.c_str ());
//    else if (item_name == ACE_TEXT_ALWAYS_CHAR (BitTorrent_Client_CNF_CHANNEL_LABEL))
...
//  result =
//    configuration_heap.open_section (configuration_heap.root_section (),
//                                     ACE_TEXT (BitTorrent_Client_CNF_CONNECTION_SECTION_HEADER),
//                                     0, // MUST exist !
//                                     section_key);
//  if (result == -1)
//  {
...
//    if (item_name == ACE_TEXT (BitTorrent_Client_CNF_SERVER_LABEL))
//    {
//      entry.hostName = ACE_TEXT_ALWAYS_CHAR (item_value.c_str ());

//      if (!entry.ports.empty ()) connections_out.push_back (entry);
//    } // end IF
//    else if (item_name == ACE_TEXT (BitTorrent_Client_CNF_PORT_LABEL))
//    {
