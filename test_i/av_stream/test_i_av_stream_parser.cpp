...
{
  YYSYMBOL_YYEMPTY = -2,
  YYSYMBOL_YYEOF = 0,                      /* "end_of_message"  */
  YYSYMBOL_YYerror = 1,                    /* error  */
  YYSYMBOL_YYUNDEF = 2,                    /* "invalid token"  */
  YYSYMBOL_TYPE = 3,                       /* "type"  */
  YYSYMBOL_LENGTH = 4,                     /* "length"  */
  YYSYMBOL_DATA = 5,                       /* "data"  */
  YYSYMBOL_BODY = 6,                       /* "body"  */
  YYSYMBOL_YYACCEPT = 7,                   /* $accept  */
  YYSYMBOL_message = 8,                    /* message  */
  YYSYMBOL_header = 9,                     /* header  */
  YYSYMBOL_10_1 = 10,                      /* $@1  */
  YYSYMBOL_msg_body = 11,                  /* msg_body  */
  YYSYMBOL_12_2 = 12,                      /* $@2  */
  YYSYMBOL_ext_msg_body = 13,              /* ext_msg_body  */
  YYSYMBOL_14_3 = 14                       /* $@3  */
};
...
yyFail (yyGLRStack* yystackp, AVStream_ParserDriver* driver, yyscan_t yyscanner, const char* yymsg)
{
  if (yymsg != YY_NULLPTR)
    yyerror (driver, yyscanner, yymsg);
...
{
  "\"end_of_message\"", "error", "\"invalid token\"", "\"type\"",
  "\"length\"", "\"data\"", "\"body\"", "$accept", "message", "header",
  "$@1", "msg_body", "$@2", "ext_msg_body", "$@3", YY_NULLPTR
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yylocationp);
  ...
  switch (yykind)
    ...
    case YYSYMBOL_msg_body: /* msg_body  */
                          { fprintf (yyo, "%d", ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_ext_msg_body: /* ext_msg_body  */
                          { fprintf (yyo, "%d", ((*yyvaluep).ival)); }
        break;
...
yy_reduce_print (yybool yynormal, yyGLRStackItem* yyvsp, YYPTRDIFF_T yyk,
                 yyRuleNum yyrule, AVStream_ParserDriver* driver, yyscan_t yyscanner);
...
static inline yysymbol_kind_t
yygetToken (int *yycharp, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
...
yyuserAction (yyRuleNum yyrule, int yyrhslen, yyGLRStackItem* yyvsp,
              ...
              YYSTYPE* yyvalp, YYLTYPE *yylocp, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
...
# define YYBACKUP(Token, Value)                                              \
  return yyerror (driver, yyscanner, YY_("syntax error: cannot back up")),     \
         yyerrok, yyerr
  ...
  switch (yyrule)
    {
  case 2: /* message: header msg_body  */
  ...
  case 7: /* msg_body: "data" $@2 ext_msg_body  */
                                                              { ((*yyvalp).ival) = (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-2)].yystate.yysemantics.yyval.ival) + (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.ival); }
    break;

  case 8: /* msg_body: "body"  */
  ...
  case 10: /* ext_msg_body: "data" $@3 ext_msg_body  */
                                                              { ((*yyvalp).ival) = (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-2)].yystate.yysemantics.yyval.ival) + (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.ival); }
    break;

  case 11: /* ext_msg_body: "body"  */
                                                              { ((*yyvalp).ival) = (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.ival);
                                                                driver->missing_ -= (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.ival);
                                                                ACE_ASSERT (!driver->missing_);
                                                                ACE_DEBUG ((LM_DEBUG,
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
  YY_USE (yyvaluep);
  YY_USE (yylocationp);
  YY_USE (driver);
...
static void
yydestroyGLRState (char const *yymsg, yyGLRState *yys, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
  if (yys->yyresolved)
  ...
  if (yystackp->yysplitPoint == YY_NULLPTR)
  ...
  else
    {
      ...
      return yyuserAction (yyrule, yynrhs, yyrhsVals + YYMAXRHS + YYMAXLEFT - 1,
                           yystackp, yyk, yyvalp, yylocp, driver, yyscanner);
    }
}
...
yyglrReduce (yyGLRStack* yystackp, YYPTRDIFF_T yyk, yyRuleNum yyrule,
             yybool yyforceEval, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
  ...
  if (yyforceEval || yystackp->yysplitPoint == YY_NULLPTR)
    {
      ...
      YYRESULTTAG yyflag = yydoAction (yystackp, yyk, yyrule, &yyval, &yyloc, driver, yyscanner);
...
static YYRESULTTAG
yyresolveValue (yyGLRState* yys, yyGLRStack* yystackp, AVStream_ParserDriver* driver, yyscan_t yyscanner);
...
yyresolveStates (yyGLRState* yys, int yyn,
                 yyGLRStack* yystackp, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
  if (0 < yyn)
    {
                 ...
                 YYSTYPE* yyvalp, YYLTYPE *yylocp, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
    ...
    yyrhsVals[YYMAXRHS + YYMAXLEFT - 1].yystate.yyloc = yyopt->yystate->yyloc;
  {
    ...
    yyflag = yyuserAction (yyopt->yyrule, yynrhs,
                           ...
                           yystackp, -1, yyvalp, yylocp, driver, yyscanner);
...
yyreportAmbiguity (yySemanticOption* yyx0,
                   yySemanticOption* yyx1, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
  YY_USE (yyx0);
  YY_USE (yyx1);
  ...
  yyerror (driver, yyscanner, YY_("syntax is ambiguous"));
  return yyabort;
}
      ...
      else
        {
          switch (yypreference (yybest, yyp))
            ...
            case 0:
              ...
              return yyreportAmbiguity (yybest, yyp, driver, yyscanner);
              break;
            case 1:
              yymerge = yytrue;
              break;
  ...
  if (yymerge)
    {
      ...
      yyflag = yyresolveAction (yybest, yystackp, &yyval, yylocp, driver, yyscanner);
      if (yyflag == yyok)
            ...
            if (yyprec == yydprec[yyp->yyrule])
              {
                YYSTYPE yyval_other;
                YYLTYPE yydummy;
                yyflag = yyresolveAction (yyp, yystackp, &yyval_other, &yydummy, driver, yyscanner);
                if (yyflag != yyok)
                  {
                    yydestruct ("Cleanup: discarding incompletely merged value for",
                                yy_accessing_symbol (yys->yylrState),
                                &yyval, yylocp, driver, yyscanner);
                    break;
                  }
...
static YYRESULTTAG
yyresolveStack (yyGLRStack* yystackp, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
  if (yystackp->yysplitPoint != YY_NULLPTR)
    {
      yyGLRState* yys;
...
yyprocessOneStack (yyGLRStack* yystackp, YYPTRDIFF_T yyk,
                   YYPTRDIFF_T yyposn, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
  while (yystackp->yytops.yystates[yyk] != YY_NULLPTR)
    {
      ...
      if (yyisDefaultedState (yystate))
        ...
        {
          yysymbol_kind_t yytoken = yygetToken (&yychar, driver, yyscanner);
...
static void
yyreportSyntaxError (yyGLRStack* yystackp, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
...
#undef YYCASE_
  ...
  if (yymsg)
    ...
    {
      yyerror (driver, yyscanner, YY_("syntax error"));
      yyMemoryExhausted (yystackp);
    }
  }
  yynerrs += 1;
...
/* Recover from a syntax error on *YYSTACKP, assuming that *YYSTACKP->YYTOKENP,
   ...
   of the lookahead.  */
static void
yyrecoverSyntaxError (yyGLRStack* yystackp, AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
    ...
    while (yytrue)
      {
        ...
        int yyj;
        if (yychar == END)
          yyFail (yystackp, driver, yyscanner, YY_NULLPTR);
        if (yychar != YYEMPTY)
          {
        ...
        yytoken = yygetToken (&yychar, driver, yyscanner);
...
int
yyparse (AVStream_ParserDriver* driver, yyscan_t yyscanner)
{
  int yyresult;
  yyGLRStack yystack;
  ...
  /* User initialization code.  */
{
      ...
      while (yytrue)
        {
          ...
          for (yys = 0; yys < yystack.yytops.yysize; yys += 1)
            YYCHK1 (yyprocessOneStack (&yystack, yys, yyposn, driver, yyscanner));
          yyremoveDeletes (&yystack);
          if (yystack.yytops.yysize == 0)
            {
              yyundeleteLastStack (&yystack);
              if (yystack.yytops.yysize == 0)
                yyFail (&yystack, driver, yyscanner, YY_("syntax error"));
 ...
 yyexhaustedlab:
  yyerror (driver, yyscanner, YY_("memory exhausted"));
  yyresult = 2;
  goto yyreturnlab;
