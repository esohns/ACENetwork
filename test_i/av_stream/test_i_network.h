...
typedef Stream_Session_Manager_T<ACE_MT_SYNCH,
                                 ...
                                 struct Stream_UserData> Test_I_Client_DirectShow_SessionManager_t;
typedef Stream_Session_Manager_T<ACE_MT_SYNCH,
                                 enum Stream_SessionMessageType,
                                 struct Stream_SessionManager_Configuration,
                                 Test_I_AVStream_Client_MediaFoundation_StreamSessionData,
                                 struct Stream_Statistic,
                                 struct Stream_UserData> Test_I_Client_MediaFoundation_SessionManager_t;
...
typedef Net_IStreamConnection_T<ACE_INET_Addr,
                                ...
                                enum Stream_StateMachine_ControlState> Test_I_AVStream_Server_DirectShow_ITCPConnection_t;
typedef Net_TCPConnectionBase_T<ACE_NULL_SYNCH,
                                Net_TCPSocketHandler_t,
                                Test_I_AVStream_Server_DirectShow_TCPConnectionConfiguration_t,
                                struct Net_StreamConnectionState,
