...
Test_I_AVStream_Server_DirectShow_SessionMessage::Test_I_AVStream_Server_DirectShow_SessionMessage (Stream_SessionId_t sessionId_in,
                                                                                                    enum Stream_SessionMessageType messageType_in,
                                                                                                    Test_I_AVStream_Server_DirectShow_StreamSessionData_t*& sessionData_in,
...
Test_I_AVStream_Server_DirectShow_SessionMessage::duplicate (void) const
{
  ...
  // create a new <Test_I_AVStream_Server_DirectShow_SessionMessage> that contains unique copies of
  ...
  if (inherited::message_block_allocator_ == NULL)
    ACE_NEW_RETURN (message_p,
                    Test_I_AVStream_Server_DirectShow_SessionMessage (*this),
                    NULL);

  // *WARNING*: the allocator returns a Test_I_AVStream_Server_DirectShow_SessionMessageBase<ConfigurationType>
  //            when passing 0 as argument to malloc()...
  ACE_NEW_MALLOC_RETURN (message_p,
                         static_cast<Test_I_AVStream_Server_DirectShow_SessionMessage*> (inherited::message_block_allocator_->malloc (0)),
                         Test_I_AVStream_Server_DirectShow_SessionMessage (*this),
                         NULL);
...
Test_I_AVStream_Server_MediaFoundation_SessionMessage::Test_I_AVStream_Server_MediaFoundation_SessionMessage (Stream_SessionId_t sessionId_in,
                                                                                                              enum Stream_SessionMessageType messageType_in,
                                                                                                              Test_I_AVStream_Server_MediaFoundation_StreamSessionData_t*& sessionData_in,
                                                                                                              struct Stream_UserData* userData_in,
                                                                                                              bool expedited_in)
 : inherited (sessionId_in,
              messageType_in,
...
Test_I_AVStream_Server_MediaFoundation_SessionMessage::duplicate (void) const
{
  ...
  // create a new <Test_I_AVStream_Server_MediaFoundation_SessionMessage> that contains unique copies of
  // the message block fields, but a reference counted duplicate of
  // the <ACE_Data_Block>.
  ...
  if (inherited::message_block_allocator_ == NULL)
    ACE_NEW_RETURN (message_p,
                    Test_I_AVStream_Server_MediaFoundation_SessionMessage (*this),
                    NULL);

  // *WARNING*: the allocator returns a Test_I_AVStream_Server_MediaFoundation_SessionMessageBase<ConfigurationType>
  //            when passing 0 as argument to malloc()...
  ACE_NEW_MALLOC_RETURN (message_p,
                         static_cast<Test_I_AVStream_Server_MediaFoundation_SessionMessage*> (inherited::message_block_allocator_->malloc (0)),
                         Test_I_AVStream_Server_MediaFoundation_SessionMessage (*this),
                         NULL);
...
Test_I_AVStream_Server_SessionMessage::duplicate (void) const
{
  ...
  // create a new <Test_I_AVStream_Server_SessionMessage> that contains unique copies of
  // the message block fields, but a reference counted duplicate of
  // the <ACE_Data_Block>.
  ...
  if (inherited::message_block_allocator_ == NULL)
    ACE_NEW_RETURN (message_p,
                    Test_I_AVStream_Server_SessionMessage (*this),
                    NULL);

  // *WARNING*: the allocator returns a Test_I_AVStream_Server_SessionMessageBase<ConfigurationType>
  //            when passing 0 as argument to malloc()...
  ACE_NEW_MALLOC_RETURN (message_p,
                         static_cast<Test_I_AVStream_Server_SessionMessage*> (inherited::message_block_allocator_->malloc (0)),
                         Test_I_AVStream_Server_SessionMessage (*this),
                         NULL);
