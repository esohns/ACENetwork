...
Test_I_AVStream_Client_DirectShow_SessionMessage::Test_I_AVStream_Client_DirectShow_SessionMessage (Stream_SessionId_t sessionId_in,
 ...
 : inherited (sessionId_in,
              ...
              userData_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_AVStream_Client_DirectShow_SessionMessage::Test_I_AVStream_Client_DirectShow_SessionMessage"));
...
{
  STREAM_TRACE (ACE_TEXT ("Test_I_AVStream_Client_DirectShow_SessionMessage::duplicate"));
...
Test_I_AVStream_Client_MediaFoundation_SessionMessage::Test_I_AVStream_Client_MediaFoundation_SessionMessage (Stream_SessionId_t sessionId_in,
 ...
 : inherited (sessionId_in,
              ...
              userData_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_AVStream_Client_MediaFoundation_SessionMessage::Test_I_AVStream_Client_MediaFoundation_SessionMessage"));
...
{
  STREAM_TRACE (ACE_TEXT ("Test_I_AVStream_Client_MediaFoundation_SessionMessage::duplicate"));
...
#else
Test_I_AVStream_Client_V4L_SessionMessage::Test_I_AVStream_Client_V4L_SessionMessage (Stream_SessionId_t sessionId_in,
                                                                                      enum Stream_SessionMessageType messageType_in,
                                                                                      Test_I_AVStream_Client_V4L_SessionData_t*& sessionData_in,
                                                                                      struct Stream_UserData* userData_in)
 : inherited (sessionId_in,
              messageType_in,
              sessionData_in,
              userData_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_AVStream_Client_V4L_SessionMessage::Test_I_AVStream_Client_V4L_SessionMessage"));

}

Test_I_AVStream_Client_V4L_SessionMessage::Test_I_AVStream_Client_V4L_SessionMessage (const Test_I_AVStream_Client_V4L_SessionMessage& message_in)
 : inherited (message_in)
{
  STREAM_TRACE (ACE_TEXT ("Test_I_AVStream_Client_V4L_SessionMessage::Test_I_AVStream_Client_V4L_SessionMessage"));
...
ACE_Message_Block*
Test_I_AVStream_Client_V4L_SessionMessage::duplicate (void) const
{
  STREAM_TRACE (ACE_TEXT ("Test_I_AVStream_Client_V4L_SessionMessage::duplicate"));

  Test_I_AVStream_Client_V4L_SessionMessage* message_p = NULL;

  // create a new <Test_I_AVStream_Client_V4L_SessionMessage> that contains unique copies of
  // the message block fields, but a reference counted duplicate of
  // the <ACE_Data_Block>.
  ...
  if (inherited::message_block_allocator_ == NULL)
    ACE_NEW_RETURN (message_p,
                    Test_I_AVStream_Client_V4L_SessionMessage (*this),
                    NULL);

  // *WARNING*: the allocator returns a Test_I_AVStream_Client_V4L_SessionMessageBase<ConfigurationType>
  //            when passing 0 as argument to malloc()
  ACE_NEW_MALLOC_RETURN (message_p,
                         static_cast<Test_I_AVStream_Client_V4L_SessionMessage*> (inherited::message_block_allocator_->malloc (0)),
                         Test_I_AVStream_Client_V4L_SessionMessage (*this),
                         NULL);
