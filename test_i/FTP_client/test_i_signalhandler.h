...
class Test_I_SignalHandler
 : public Common_SignalHandler_T<struct FTP_Client_SignalHandlerConfiguration>
{
  typedef Common_SignalHandler_T<struct FTP_Client_SignalHandlerConfiguration> inherited;
