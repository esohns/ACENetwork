...
bool
Test_I_ConnectionStream::load (Stream_ILayout* layout_inout,
                               bool& deleteModules_out)
{
  ...
  module_p = NULL;
  ACE_NEW_RETURN (module_p,
                  FTP_Client_Module_Marshal_Module (this,
...
//  struct FTP_Client_SessionData* session_data_p = NULL;
...
//                ACE_TEXT (connection_stream_name_string_)));
//    goto failed;
//  } // end IF
//  const_cast<inherited::CONFIGURATION_T&> (configuration_in).configuration_->setupPipeline =
//    setup_pipeline;
...
//  session_data_p =
//    &const_cast<struct FTP_Client_SessionData&> (inherited::sessionData_->getR ());
//  //iterator =
