...
#ifndef TEST_I_FTP_CLIENT_DEFINES_H
#define TEST_I_FTP_CLIENT_DEFINES_H

#define TEST_I_DEFAULT_GTK_RC_FILE                        "resources.rc"
#if defined (GTK2_USE)
#define TEST_I_DEFAULT_GLADE_FILE                         "test_i.gtk2"
#elif defined (GTK3_USE)
#define TEST_I_DEFAULT_GLADE_FILE                         "test_i.gtk3"
...
#define TEST_I_UI_GTK_COMBOBOX_INTERFACE_NAME             "combobox_interface"
...
#define TEST_I_UI_GTK_SPINBUTTON_SERVER_PORT_NAME         "spinbutton_server_port"
...
#define TEST_I_UI_GTK_TOGGLEBUTTON_PASV_NAME              "togglebutton_pasv"
