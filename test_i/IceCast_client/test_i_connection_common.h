...
typedef Net_StreamConnectionConfiguration_T<Test_I_IceCastClient_StreamConfiguration_t,
                                            NET_TRANSPORTLAYER_TCP> Test_I_IceCastClient_ConnectionConfiguration_t;
...
typedef Net_StreamConnectionConfiguration_T<Test_I_IceCastClient_StreamConfiguration_2_t,
                                           NET_TRANSPORTLAYER_TCP> Test_I_IceCastClient_ConnectionConfiguration_2_t;
...
typedef Net_StreamConnectionConfiguration_T<Test_I_IceCastClient_StreamConfiguration_3_t,
                                            NET_TRANSPORTLAYER_TCP> Test_I_IceCastClient_ConnectionConfiguration_3_t;
...
typedef Test_I_IConnection_t Test_I_IConnection_2_t;
typedef Net_IStreamConnection_T<ACE_INET_Addr,
                                Test_I_IceCastClient_ConnectionConfiguration_2_t,
                                struct HTTP_ConnectionState,
                                HTTP_Statistic_t,
                                Net_TCPSocketConfiguration_t,
...
typedef Net_IConnector_T<ACE_INET_Addr,
                         Test_I_IceCastClient_ConnectionConfiguration_t> Test_I_IConnector_t;
...
typedef Net_IConnector_T<ACE_INET_Addr,
                        Test_I_IceCastClient_ConnectionConfiguration_2_t> Test_I_IConnector_2_t;
