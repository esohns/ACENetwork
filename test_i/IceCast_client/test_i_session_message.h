...
{
  Test_I_IceCastClient_SessionData ()
   : Test_I_StreamSessionData ()
  ...
  struct Test_I_IceCastClient_SessionData& operator= (const struct Test_I_IceCastClient_SessionData& rhs_in)
  {
                                      ...
                                      struct Stream_UserData>
{
 ...
 public:
  ...
  Test_I_SessionMessage (Stream_SessionId_t,
                         enum Stream_SessionMessageType,
                         Test_I_IceCastClient_SessionData_t*&, // session data container handle
                         struct Stream_UserData*,
                         bool); // expedited ?
 ...
 , public Stream_IMediaType
{
 ...
 public:
  ...
  Test_I_SessionMessage_2 (Stream_SessionId_t,
                           enum Stream_SessionMessageType,
                           Test_I_IceCastClient_SessionData_2_t*&, // session data container handle
                           struct Stream_UserData*,
                           bool); // expedited ?
  // copy ctor to be used by duplicate()
