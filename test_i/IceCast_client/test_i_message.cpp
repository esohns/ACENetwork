...
Test_I_MessageDataContainer::Test_I_MessageDataContainer (struct Test_I_IceCastClient_MessageData*& messageData_in,
                                                          bool delete_in)
...
Test_I_MessageDataContainer::setPR (struct HTTP_Record*& record_inout)
{
  ...
  struct Test_I_IceCastClient_MessageData* data_p = NULL;
...
void
Test_I_Message::initialize (Test_I_MessageDataContainer& data_in,
                            Stream_SessionId_t sessionId_in,
                            ACE_Data_Block* dataBlock_in)
{
  NETWORK_TRACE (ACE_TEXT ("Test_I_Message::initialize"));
  ...
  data_container_p->setR (data_in.getR ());
  inherited::initialize (data_container_p,
                         sessionId_in,
                         dataBlock_in);
}
...
Test_I_MessageDataContainer_3::Test_I_MessageDataContainer_3 ()
 : inherited ()
{
  NETWORK_TRACE (ACE_TEXT ("Test_I_MessageDataContainer_3::Test_I_MessageDataContainer_3"));

}

Test_I_MessageDataContainer_3::Test_I_MessageDataContainer_3 (struct Test_I_IceCastClient_MessageData_3*& messageData_in,
                                                              bool delete_in)
 : inherited (messageData_in,
              delete_in)
{
...
void
Test_I_MessageDataContainer_3::setPR (struct HTTP_Record*& record_inout)
{
  NETWORK_TRACE (ACE_TEXT ("Test_I_MessageDataContainer_3::setPR"));

  struct Test_I_IceCastClient_MessageData_3* data_p = NULL;
  ACE_NEW_NORETURN (data_p,
...
Test_I_Message_3::Test_I_Message_3 (Stream_SessionId_t sessionId_in,
                                    unsigned int size_in)
 : inherited (sessionId_in,
              size_in)
{
  NETWORK_TRACE (ACE_TEXT ("Test_I_Message_3::Test_I_Message_3"));

}

Test_I_Message_3::Test_I_Message_3 (const Test_I_Message_3& message_in)
 : inherited (message_in)
{
  NETWORK_TRACE (ACE_TEXT ("Test_I_Message_3::Test_I_Message_3"));
...
ACE_Message_Block*
Test_I_Message_3::clone (ACE_Message_Block::Message_Flags flags_in) const
{
  NETWORK_TRACE (ACE_TEXT ("Test_I_Message_3::clone"));
  ...
  // step1: "deep"-copy the fragment chain
  Test_I_Message_3* result_p = NULL;
  ...
  if (inherited::message_block_allocator_)
  {
    ...
    //         the returned memory is always sizeof(ARDrone_LiveVideoMessage)
    ACE_NEW_MALLOC_NORETURN (result_p,
                             static_cast<Test_I_Message_3*> (inherited::message_block_allocator_->calloc (sizeof (Test_I_Message_3),
                                                                                                          '\0')),
                             Test_I_Message_3 (inherited::sessionId_,
                                               data_block_p,
                                               inherited::message_block_allocator_,
                                               true));
  } // end IF
  ...
  if (inherited::isInitialized_)
  {
    Test_I_MessageDataContainer_3* data_container_p = NULL;
    ACE_NEW_NORETURN (data_container_p,
...
ACE_Message_Block*
Test_I_Message_3::duplicate (void) const
{
  NETWORK_TRACE (ACE_TEXT ("Test_I_Message_3::duplicate"));

  Test_I_Message_3* message_p = NULL;
...
void
Test_I_Message_3::initialize (Test_I_MessageDataContainer_3& data_in,
                              Stream_SessionId_t sessionId_in,
                              ACE_Data_Block* dataBlock_in)
{
  NETWORK_TRACE (ACE_TEXT ("Test_I_Message_3::initialize"));
