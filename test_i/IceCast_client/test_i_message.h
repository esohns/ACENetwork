...
{
  typedef Stream_DataBase_T<struct Test_I_IceCastClient_MessageData> inherited;

 public:
   Test_I_MessageDataContainer ();
  // *IMPORTANT NOTE*: fire-and-forget API
  Test_I_MessageDataContainer (struct Test_I_IceCastClient_MessageData*&, // data handle
 ...
 , public Stream_IMediaType
{
 ...
 public:
  ...
  virtual void initialize (Test_I_MessageDataContainer&, // message data handle
