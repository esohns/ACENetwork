...
ACE_HANDLE
ACE_Streambuf_alt::get_handle (void)
{
  return 0;
}

ACE_Time_Value*
ACE_Streambuf_alt::recv_timeout (ACE_Time_Value *tv)
{
...
int
ACE_Streambuf_alt::underflow (void)
{
...
int
ACE_Streambuf_alt::overflow (int c)
{
...
int
ACE_Streambuf_alt::syncout (void)
{
...
int
ACE_Streambuf_alt::flushbuf (void)
{
...
int
ACE_Streambuf_alt::get_one_byte (void)
{
  this->timeout_ = 0;
...
int
ACE_Streambuf_alt::fillbuf (void)
{
...
u_int
ACE_Streambuf_alt::streambuf_size (void)
{
...
// gptr.
u_int
ACE_Streambuf_alt::get_waiting (void)
{
...
u_int
ACE_Streambuf_alt::get_avail (void)
{
...
u_int
ACE_Streambuf_alt::put_avail (void)
{
...
char*
ACE_Streambuf_alt::reset_get_buffer (char* newBuffer,
...
char*
ACE_Streambuf_alt::reset_put_buffer (char* newBuffer,
                                     u_int _streambuf_size,
                                     u_int _pptr)
{
...
void
ACE_Streambuf_alt::reset_base (void)
{
...
ACE_Streambuf_alt::~ACE_Streambuf_alt (void)
{
...
u_char
ACE_Streambuf_alt::timeout (void)
{
