...
void
Test_I_Encoder::handleSessionMessage (Test_I_SessionMessage*& message_inout,
                                      bool& passMessageDownstream_out)
{
  ...
  switch (message_inout->type ())
  {
    case STREAM_SESSION_MESSAGE_BEGIN:
    {
      ...
      typename Test_I_URLStreamLoad_SessionData_t::DATA_T& session_data_r =
        const_cast<typename Test_I_URLStreamLoad_SessionData_t::DATA_T&> (inherited::sessionData_->getR ());
