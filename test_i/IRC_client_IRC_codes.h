...
#ifndef IRC_CLIENT_IRC_CODES_H
#define IRC_CLIENT_IRC_CODES_H

#include "ace/Global_Macros.h"

class IRC_Client_IRC_Codes
{
 public:
...
//     RPL_OMOTD             = 721,
    ...
    ERR_NUMERIC_ERR       = 999,
    //
    IRC_CLIENT_IRC_CODE_MAX,
    IRC_CLIENT_IRC_CODE_INVALID
  };

 private:
  ACE_UNIMPLEMENTED_FUNC (IRC_Client_IRC_Codes ());
  ACE_UNIMPLEMENTED_FUNC (IRC_Client_IRC_Codes (const IRC_Client_IRC_Codes&));
  ACE_UNIMPLEMENTED_FUNC (IRC_Client_IRC_Codes& operator= (const IRC_Client_IRC_Codes&));
  ACE_UNIMPLEMENTED_FUNC (virtual ~IRC_Client_IRC_Codes ());
};

// convenience typedef
typedef IRC_Client_IRC_Codes::RFC1459Numeric IRC_Client_IRCNumeric_t;
