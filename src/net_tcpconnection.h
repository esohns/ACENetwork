...
class Net_Export Net_TCPConnection
 : public Net_SocketConnectionBase<Net_TCPHandler,
...
//   virtual int handle_input(ACE_HANDLE = ACE_INVALID_HANDLE);
 ...
 private:
  typedef Net_SocketConnectionBase<Net_TCPHandler,
                                       Net_TransportLayer_TCP,
                                       Net_ConfigPOD,
...
class Net_Export Net_AsynchTCPConnection
 : public Net_SocketConnectionBase<Net_AsynchTCPHandler,
                                       Net_TransportLayer_TCP,
                                       Net_ConfigPOD,
                                       Net_RuntimeStatistic>
{
 ...
 private:
  typedef Net_SocketConnectionBase<Net_AsynchTCPHandler,
                                       Net_TransportLayer_TCP,
                                       Net_ConfigPOD,
                                       Net_RuntimeStatistic> inherited;
