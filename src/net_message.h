...
class Net_Message
 : public Net_MessageBase_T<Net_MessageType>
{
 ...
 public:
  ...
  virtual Net_MessageType getCommand () const; // return value: message type
  ...
  static std::string commandType2String (const Net_MessageType&);
 ...
 private:
  typedef Net_MessageBase_T<Net_MessageType> inherited;
