...
Net_UDPSocketHandler::Net_UDPSocketHandler()//MANAGER_T* manager_in)
 //: inherited ()
...
{
  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::Net_UDPSocketHandler"));
...
Net_UDPSocketHandler::~Net_UDPSocketHandler()
{
  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::~Net_UDPSocketHandler"));
...
//Net_UDPSocketHandler::add_reference(void)
//{
//  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::add_reference"));
//
//  inherited2::increase();
//
...
//
//ACE_Event_Handler::Reference_Count
//Net_UDPSocketHandler::remove_reference(void)
//{
//  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::remove_reference"));
//
...
int
Net_UDPSocketHandler::open(void* arg_in)
{
  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::open"));
...
int
Net_UDPSocketHandler::handle_close(ACE_HANDLE handle_in,
                                       ACE_Reactor_Mask mask_in)
{
  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::handle_close"));
...
//void
//Net_UDPSocketHandler::info(ACE_HANDLE& handle_out,
//                               ACE_INET_Addr& localSAP_out,
//                               ACE_INET_Addr& remoteSAP_out) const
//{
//  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::info"));
...
//void
//Net_UDPSocketHandler::close()
//{
//  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::close"));
...
//unsigned int
//Net_UDPSocketHandler::id() const
//{
//  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::id"));
...
//void
//Net_UDPSocketHandler::increase()
//{
//  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::increase"));
//
//  inherited2::increase();
...
//
//void
//Net_UDPSocketHandler::decrease()
//{
//  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::decrease"));
//
//  // *NOTE*: may "delete this"
//  inherited2::decrease();
//  //// *NOTE*: may "delete this"
...
//void
//Net_UDPSocketHandler::dump_state() const
//{
//  NETWORK_TRACE(ACE_TEXT("Net_UDPSocketHandler::dump_state"));
//
