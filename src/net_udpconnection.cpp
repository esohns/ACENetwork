...
{
  RPG_TRACE (ACE_TEXT ("Net_UDPConnection::Net_UDPConnection"));
...
{
  RPG_TRACE (ACE_TEXT ("Net_UDPConnection::info"));
...
//{
//  RPG_TRACE (ACE_TEXT ("Net_UDPConnection::svc"));
//
//  ACE_DEBUG ((LM_DEBUG,
...
{
  RPG_TRACE (ACE_TEXT ("Net_UDPConnection::open"));
...
{
  RPG_TRACE (ACE_TEXT ("Net_UDPConnection::close"));
...
{
  RPG_TRACE (ACE_TEXT ("Net_UDPConnection::handle_output"));
...
{
  RPG_TRACE (ACE_TEXT ("Net_UDPConnection::handle_close"));
...
//{
//  RPG_TRACE (ACE_TEXT ("Net_UDPConnection::shutdown"));
//
