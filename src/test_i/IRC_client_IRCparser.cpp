...
namespace yy {
  ...
  inline void
  IRC_Client_IRCParser::yy_symbol_value_print_ (int yytype,
  ...
  void
  IRC_Client_IRCParser::yy_symbol_print_ (int yytype,
         const semantic_type* yyvaluep, const location_type* yylocationp)
  {
  ...
  void
  IRC_Client_IRCParser::yydestruct_ (const char* yymsg,
...
/*                                                                ACE_DEBUG((LM_DEBUG,
  ...
  std::string
  IRC_Client_IRCParser::yysyntax_error_ (int yystate, int yytoken)
  {
    std::string yyres;
...
#undef YYCASE_
  ...
  IRC_Client_IRCParser::yytoken_number_[] =
  {
  ...
  const IRC_Client_IRCParser::rhs_number_type
  IRC_Client_IRCParser::yyrhs_[] =
  {
  ...
  const int IRC_Client_IRCParser::yyeof_ = 0;
  const int IRC_Client_IRCParser::yylast_ = 23;
  const int IRC_Client_IRCParser::yynnts_ = 8;
  const int IRC_Client_IRCParser::yyempty_ = -2;
  const int IRC_Client_IRCParser::yyfinal_ = 10;
  const int IRC_Client_IRCParser::yyterror_ = 1;
  const int IRC_Client_IRCParser::yyerrcode_ = 256;
  const int IRC_Client_IRCParser::yyntokens_ = 13;

  const unsigned int IRC_Client_IRCParser::yyuser_token_number_max_ = 264;
  const IRC_Client_IRCParser::token_number_type IRC_Client_IRCParser::yyundef_token_ = 2;
...
{
  ACE_TRACE(ACE_TEXT("IRC_Client_IRCParser::error"));
...
{
  ACE_TRACE(ACE_TEXT("IRC_Client_IRCParser::set"));
