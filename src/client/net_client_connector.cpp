...
int
Net_Client_Connector::make_svc_handler (Net_TCPConnection*& handler_inout)
{
...
void
Net_Client_Connector::connect (const ACE_INET_Addr& peer_address)
{
