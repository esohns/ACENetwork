...
namespace yy {
  ...
  std::string* sval;
    ...
    USER = 260,                    // "user"
    HOST = 261,                    // "host"
    CMD_STRING = 262,              // "cmd_string"
    CMD_NUMERIC = 263,             // "cmd_numeric"
    PARAM = 264                    // "param"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_USER = 5,                              // "user"
        S_HOST = 6,                              // "host"
        S_CMD_STRING = 7,                        // "cmd_string"
        S_CMD_NUMERIC = 8,                       // "cmd_numeric"
        S_PARAM = 9,                             // "param"
        S_10_ = 10,                              // ':'
        S_11_ = 11,                              // '!'
        S_12_ = 12,                              // '@'
        S_YYACCEPT = 13,                         // $accept
        S_message = 14,                          // message
        S_prefix = 15,                           // prefix
        S_ext_prefix = 16,                       // ext_prefix
        S_body = 17,                             // body
        S_command = 18,                          // command
        S_params = 19,                           // params
        S_trailing = 20                          // trailing
      };
    };
    ...
    struct basic_symbol : Base
    {
      ...
      {
        return IRC_Parser::symbol_name (this->kind ());
      }
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    IRC_Parser (const IRC_Parser&) = delete;
    /// Non copyable.
    IRC_Parser& operator= (const IRC_Parser&) = delete;
#endif
    ...
    {
    public:
      context (const IRC_Parser& yyparser, const symbol_type& yyla);
