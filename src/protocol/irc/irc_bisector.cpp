...
#define IRC_Bisector_wrap(yyscanner) (/*CONSTCOND*/1)
...
void IRC_Bisector_set_in  (FILE * _in_str ,yyscan_t yyscanner );

FILE *IRC_Bisector_get_out (yyscan_t yyscanner );

void IRC_Bisector_set_out  (FILE * _out_str ,yyscan_t yyscanner );

			int IRC_Bisector_get_leng (yyscan_t yyscanner );

char *IRC_Bisector_get_text (yyscan_t yyscanner );

int IRC_Bisector_get_lineno (yyscan_t yyscanner );

void IRC_Bisector_set_lineno (int _line_number ,yyscan_t yyscanner );

int IRC_Bisector_get_column  (yyscan_t yyscanner );

void IRC_Bisector_set_column (int _column_no ,yyscan_t yyscanner );
...
YY_BUFFER_STATE IRC_Bisector__scan_string (yyconst char * yystr , yyscan_t yyscanner)
{
	...
	return IRC_Bisector__scan_bytes(yystr,(int) strlen(yystr) ,yyscanner);
}
/* %endif */
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE IRC_Bisector__scan_bytes  (yyconst char * yybytes, int  _yybytes_len , yyscan_t yyscanner)
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
...
void IRC_Bisector_set_debug (int  _bdebug , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
