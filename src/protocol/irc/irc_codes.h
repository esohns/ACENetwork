...
{
 public:
  // *TODO*: this has been adapted to cover different implementation-specific
  //         extensions --> revise
...
//     RPL_OMOTD             = 721,
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (IRC_Codes ())
  ACE_UNIMPLEMENTED_FUNC (IRC_Codes (const IRC_Codes&))
  ACE_UNIMPLEMENTED_FUNC (IRC_Codes& operator= (const IRC_Codes&))
  ACE_UNIMPLEMENTED_FUNC (virtual ~IRC_Codes ())
};

// convenience typedef
typedef IRC_Codes::RFC1459Numeric IRC_NumericCommand_t;
