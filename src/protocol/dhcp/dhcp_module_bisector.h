...
#ifndef DHCP_MODULE_BISECTOR_H
#define DHCP_MODULE_BISECTOR_H
...
//// define/declare the lexer's prototype (see DHCP_bisector.h)
typedef void* yyscan_t;
extern int DHCP_Bisector_lex (yyscan_t);
//// *TODO*: this should be part of DHCP_bisector.h
//#define YY_DECL extern int DHCP_Bisector_lex (yyscan_t)
//YY_DECL;
...
{
 public:
  DHCP_Module_Bisector_T ();
  virtual ~DHCP_Module_Bisector_T ();
...
//#if defined (__GNUG__) || defined (_MSC_VER)
 ...
 private:
  ...
  ACE_UNIMPLEMENTED_FUNC (DHCP_Module_Bisector_T (const DHCP_Module_Bisector_T&))
  ACE_UNIMPLEMENTED_FUNC (DHCP_Module_Bisector_T& operator= (const DHCP_Module_Bisector_T&))

  // convenience types
  typedef Stream_StatisticHandler_Reactor_T<StatisticContainerType> STATISTICHANDLER_T;
  //typedef DHCP_Client_SessionData SESSIONDATA_T;
...
#include "dhcp_module_bisector.inl"
