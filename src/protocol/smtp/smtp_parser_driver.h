...
#ifndef SMTP_PARSER_DRIVER_T_H
#define SMTP_PARSER_DRIVER_T_H
 ...
 : public SMTP_IParser
{
 ...
 private:
...
#if defined (_DEBUG)
  inline virtual bool debug () const { return !(SMTP_Scanner_get_debug (scannerState_) == 0); }
#endif // _DEBUG
  ...
  virtual bool initialize (yyscan_t&,             // return value: state handle
                           SMTP_IParser* = NULL); // 'extra' data handle
...
#include "smtp_parser_driver.inl"
