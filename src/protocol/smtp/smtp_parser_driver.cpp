...
SMTP_ParserDriver::SMTP_ParserDriver (bool traceScanning_in,
...
//           scannerState_)      // scanner
 ...
 , initialized_ (false)
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::SMTP_ParserDriver"));
  ...
  // trace ?
  SMTP_Scanner_set_debug ((traceScanning_in ? 1 : 0),
                          scannerState_);
#if YYDEBUG
...
SMTP_ParserDriver::~SMTP_ParserDriver ()
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::~SMTP_ParserDriver"));
...
bool
SMTP_ParserDriver::getDebugScanner () const
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::getDebugScanner"));

  return (SMTP_Scanner_get_debug (scannerState_) != 0);
}

bool
SMTP_ParserDriver::initialize (const struct Common_ParserConfiguration& configuration_in)
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::initialize"));
...
bool
SMTP_ParserDriver::parse (ACE_Message_Block* data_in)
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::parse"));
  ...
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to SMTP_ParserDriver::scan_begin(), aborting\n")));
...
void
SMTP_ParserDriver::error (const yy::location& location_in,
                          const std::string& message_in)
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::error"));
...
void
SMTP_ParserDriver::error (const std::string& message_in)
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::error"));
...
void
SMTP_ParserDriver::error (const YYLTYPE& location_in,
                          const std::string& message_in)
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::error"));
...
bool
SMTP_ParserDriver::scan_begin ()
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::scan_begin"));
...
void
SMTP_ParserDriver::scan_end ()
{
  NETWORK_TRACE (ACE_TEXT ("SMTP_ParserDriver::scan_end"));
