...
class SMTP_Codes
{
 public:
  ...
  enum CodeType
  {
    ...
    SMTP_CODE_HOST_DOES_NOT_ACCEPT_MAIL = 521, // rfc1846
    SMTP_CODE_AUTHENTICATION_REQUIRED = 530, // rfc4954
    SMTP_CODE_AUTHENTICATION_MECHANISM_TOO_WEAK = 534, // rfc4954
    SMTP_CODE_AUTHENTICATION_CREDENTIALS_INVALID = 535, // rfc4954
    SMTP_CODE_ENCRYPTION_REQUIRED_FOR_AUTHENTICATION_MECHANISM = 538, // rfc4954
