...
@rem @copy /A /V /Y smtp_parser_patched.h .\..\smtp_parser.h >NUL
@rem @del /F /Q smtp_parser.h >NUL
if %ERRORLEVEL% NEQ 0 (
...
@move /Y smtp_parser.cpp .\.. >NUL
@move /Y smtp_parser.h .\.. >NUL
