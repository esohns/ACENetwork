...
#ifndef PCP_SESSIONMESSAGE_T_H
#define PCP_SESSIONMESSAGE_T_H
                                      ...
                                      UserDataType>
{
 ...
 //                                               ControlMessageType,
 //                                               DataMessageType,
 //                                               PCP_SessionMessage_T<ControlMessageType,
 //                                                                     DataMessageType,
 //                                                                     SessionDataType> >;
 ...
 public:
  // convenient types
  typedef PCP_SessionMessage_T<AllocatorType,
                                SessionDataType,
                                UserDataType> OWN_TYPE_T;

  // *NOTE*: assume lifetime responsibility for the second argument !
  PCP_SessionMessage_T (enum Stream_SessionMessageType, // session message type
                        SessionDataType*&,              // session data container handle
                        UserDataType*);                 // user data handle
  // *NOTE*: to be used by message allocators
  PCP_SessionMessage_T (ACE_Allocator*); // message allocator
  PCP_SessionMessage_T (ACE_Data_Block*, // data block
                        ACE_Allocator*); // message allocator
  inline virtual ~PCP_SessionMessage_T () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (PCP_SessionMessage_T ())
  // copy ctor (to be used by duplicate())
  PCP_SessionMessage_T (const PCP_SessionMessage_T&);
  ACE_UNIMPLEMENTED_FUNC (PCP_SessionMessage_T& operator= (const PCP_SessionMessage_T&))
};

// include template definition
#include "pcp_sessionmessage.inl"
