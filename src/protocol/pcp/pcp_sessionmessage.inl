...
PCP_SessionMessage_T<AllocatorType,
                      SessionDataType,
                      UserDataType>::PCP_SessionMessage_T (enum Stream_SessionMessageType messageType_in,
 ...
 : inherited (messageType_in,
              ...
              userData_in)
{
  NETWORK_TRACE (ACE_TEXT ("PCP_SessionMessage_T::PCP_SessionMessage_T"));
...
PCP_SessionMessage_T<AllocatorType,
                      SessionDataType,
                      UserDataType>::PCP_SessionMessage_T (const PCP_SessionMessage_T& message_in)
...
PCP_SessionMessage_T<AllocatorType,
                      SessionDataType,
                      UserDataType>::PCP_SessionMessage_T (ACE_Allocator* messageAllocator_in)
...
PCP_SessionMessage_T<AllocatorType,
                      SessionDataType,
                      UserDataType>::PCP_SessionMessage_T (ACE_Data_Block* dataBlock_in,
...
{
  NETWORK_TRACE (ACE_TEXT ("PCP_SessionMessage_T::duplicate"));

  OWN_TYPE_T* message_p = NULL;

  // *NOTE*: create a new PCP_SessionMessage_T that contains unique copies of
    ...
    if (inherited::message_block_allocator_)
    {
      ...
      if (allocator_p->block ())
        ACE_DEBUG ((LM_CRITICAL,
                    ACE_TEXT ("failed to allocate PCP_SessionMessage_T: \"%m\", aborting\n")));
    } // end IF
    else
      ACE_DEBUG ((LM_CRITICAL,
                  ACE_TEXT ("failed to allocate PCP_SessionMessage_T: \"%m\", aborting\n")));
