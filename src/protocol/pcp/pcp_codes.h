...
class PCP_Codes
{
 public:
  ...
  enum OpcodeType
  {
    ...
    PCP_OPCODE_MAP = 1,
    PCP_OPCODE_PEER = 2,
    PCP_OPCODE_AUTHENTICATION = 3, // rfc7652
    PCP_OPCODE_STANDARDS_ACTION_BEGIN = 4,
  ...
  enum ResultCodeType
  {
    ...
    PCP_RESULTCODE_INITIATION, // rfc7652
    PCP_RESULTCODE_AUTHENTICATION_REQUIRED, // rfc7652
    PCP_RESULTCODE_AUTHENTICATION_FAILED, // rfc7652
    PCP_RESULTCODE_AUTHENTICATION_SUCCEEDED, // rfc7652
    PCP_RESULTCODE_AUTHORIZATION_FAILED, // rfc7652
    PCP_RESULTCODE_SESSION_TERMINATED, // rfc7652
    PCP_RESULTCODE_UNKNOWN_SESSION_ID, // rfc7652
    PCP_RESULTCODE_DOWNGRADE_ATTACK_DETECTED, // rfc7652
    PCP_RESULTCODE_AUTHENTICATION_REQUEST, // rfc7652
    PCP_RESULTCODE_AUTHENTICATION_REPLY, // rfc7652
    PCP_RESULTCODE_STANDARDS_ACTION_BEGIN = 24,
  ...
  enum OptionType
  {
    ...
    PCP_OPTION_FILTER,
    PCP_OPTION_NONCE, // rfc7652
    PCP_OPTION_AUTHENTICATION_TAG, // rfc7652
    PCP_OPTION_PA_AUTHENTICATION_TAG, // rfc7652
    PCP_OPTION_EAP_PAYLOAD, // rfc7652
    PCP_OPTION_PSEUDO_RANDOM_FUNCTION, // rfc7652
    PCP_OPTION_MAC_ALGORITHM, // rfc7652
    PCP_OPTION_SESSION_LIFETIME, // rfc7652
    PCP_OPTION_RECEIVED_PAK, // rfc7652
    PCP_OPTION_ID_INDICATOR, // rfc7652
    /////////////////////////////////////
    PCP_OPTION_MAX,
    PCP_OPTION_INVALID
  };
