...
FTP_ParserDriver_T<SessionMessageType>::FTP_ParserDriver_T ()
 : finished_ (false)
 , fragment_ (NULL)
 , offset_ (0)
 , record_ (NULL)
...
FTP_ParserDriver_T<SessionMessageType>::~FTP_ParserDriver_T ()
{
  ...
  if (FTP_Scanner_lex_destroy (scannerState_))
    ACE_DEBUG ((LM_ERROR,
...
template <typename SessionMessageType>
bool
FTP_ParserDriver_T<SessionMessageType>::initialize (const struct Common_FlexBisonParserConfiguration& configuration_in)
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::initialize"));
...
template <typename SessionMessageType>
bool
FTP_ParserDriver_T<SessionMessageType>::parse (ACE_Message_Block* data_in)
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::parse"));
  ...
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to FTP_ParserDriver_T::scan_begin(), aborting\n")));
  ...
  // initialize scanner
  offset_ = 0;
  FTP_Scanner_set_column (1, scannerState_);
  FTP_Scanner_set_lineno (1, scannerState_);
  int debug_level = 0;
#if YYDEBUG
  ...
  switch (result)
  {
    ...
    { // *NOTE*: need more data ?
      ...
      { ACE_ASSERT (record_);
        ACE_DEBUG ((LM_DEBUG,
                    ACE_TEXT ("%s\n"),
                    ACE_TEXT (FTP_Tools::dump (*record_).c_str ())));
      } // end IF
      break;
    }
  } // end SWITCH
...
template <typename SessionMessageType>
void
FTP_ParserDriver_T<SessionMessageType>::error (const std::string& message_in)
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::error"));
...
//template <typename SessionMessageType>
//bool
//FTP_ParserDriver_T<SessionMessageType>::getDebugScanner () const
//{
//  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::getDebugScanner"));
//
...
template <typename SessionMessageType>
bool
FTP_ParserDriver_T<SessionMessageType>::switchBuffer (bool unlink_in)
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::switchBuffer"));
...
//                  ACE_TEXT ("no data after HTTP_ParserDriver_T::waitBuffer(), aborting\n")));
  ...
  *(fragment_->wr_ptr () + 1) = YY_END_OF_BUFFER_CHAR;
  ...
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to FTP_ParserDriver_T::begin(), aborting\n")));
    return false;
  } // end IF
...
template <typename SessionMessageType>
void
FTP_ParserDriver_T<SessionMessageType>::waitBuffer ()
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::waitBuffer"));
...
template <typename SessionMessageType>
void
FTP_ParserDriver_T<SessionMessageType>::setDebug (yyscan_t context_in,
                                                  bool debug_in)
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::setDebug"));

  ACE_ASSERT (context_in);

  FTP_Scanner_set_debug ((debug_in ? 1 : 0), context_in);
}

template <typename SessionMessageType>
void
FTP_ParserDriver_T<SessionMessageType>::reset ()
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::reset"));
...
template <typename SessionMessageType>
bool
FTP_ParserDriver_T<SessionMessageType>::initialize (yyscan_t& context_out,
                                                     FTP_IParser* extra_in)
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::initialize"));

  ACE_ASSERT (!context_out);

  int result = FTP_Scanner_lex_init_extra (extra_in, &context_out);
  if (result)
  {
    ACE_DEBUG ((LM_ERROR,
...
template <typename SessionMessageType>
void
FTP_ParserDriver_T<SessionMessageType>::finalize (yyscan_t& context_in)
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::finalize"));

  ACE_ASSERT (context_in);

  int result = FTP_Scanner_lex_destroy (context_in);
  if (result)
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to FTP_Scanner_lex_destroy(): \"%m\", returning\n")));
}

template <typename SessionMessageType>
struct yy_buffer_state*
FTP_ParserDriver_T<SessionMessageType>::create (yyscan_t context_in,
                                                 char* buffer_in,
                                                 size_t size_in)
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::create"));

  ACE_ASSERT (context_in);

  struct yy_buffer_state* result = FTP_Scanner__scan_buffer (buffer_in,
                                                              size_in,
                                                              context_in);
  if (!result)
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to FTP_Scanner__scan_buffer(): \"%m\", aborting\n")));
...
template <typename SessionMessageType>
void
FTP_ParserDriver_T<SessionMessageType>::destroy (yyscan_t context_in,
                                                  struct yy_buffer_state*& buffer_inout)
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::destroy"));

  ACE_ASSERT (context_in);

  FTP_Scanner__delete_buffer (buffer_inout,
                               context_in);
  buffer_inout = NULL;
}
...
template <typename SessionMessageType>
bool
FTP_ParserDriver_T<SessionMessageType>::scan_begin ()
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::scan_begin"));
  ...
  {
    bufferState_ =
      FTP_Scanner__scan_buffer (fragment_->rd_ptr (),
  ...
  {
    bufferState_ =
      FTP_Scanner__scan_bytes (fragment_->rd_ptr (),
                                fragment_->length (),
                                scannerState_);
  } // end ELSE
  if (!bufferState_)
...
template <typename SessionMessageType>
void
FTP_ParserDriver_T<SessionMessageType>::scan_end ()
{
  NETWORK_TRACE (ACE_TEXT ("FTP_ParserDriver_T::scan_end"));
