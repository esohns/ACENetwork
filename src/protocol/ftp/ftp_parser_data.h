...
#ifndef YY_ZZ_FTP_PARSER_DATA_H_INCLUDED
# define YY_ZZ_FTP_PARSER_DATA_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 1
#endif
...
int zzparse (FTP_IParserData* driver, yyscan_t yyscanner);

#endif /* !YY_ZZ_FTP_PARSER_DATA_H_INCLUDED  */
