...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LIST_DIRECTORY = 3,             /* "directory"  */
  YYSYMBOL_LIST_FILE = 4,                  /* "file"  */
  YYSYMBOL_RAW_DATA = 5,                   /* "data"  */
  YYSYMBOL_YYACCEPT = 6,                   /* $accept  */
  YYSYMBOL_stream = 7,                     /* stream  */
  YYSYMBOL_items = 8,                      /* items  */
...
#define zznerrs yynerrs
#define zzchar yychar
#define zzlval yylval
#define zzlloc yylloc
...
yyFail (yyGLRStack* yystackp, YYLTYPE *yylocp, FTP_IParserData* driver, yyscan_t yyscanner, const char* yymsg)
{
  if (yymsg != YY_NULLPTR)
...
{
  "\"end\"", "error", "\"invalid token\"", "\"directory\"", "\"file\"",
  "\"data\"", "$accept", "stream", "items", "item", YY_NULLPTR
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, FTP_IParserData* driver, yyscan_t yyscanner)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yylocationp);
  ...
  switch (yykind)
    ...
    case YYSYMBOL_LIST_DIRECTORY: /* "directory"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %s"), (((*yyvaluep).sval)->c_str ())); }
        break;

    case YYSYMBOL_LIST_FILE: /* "file"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %s"), (((*yyvaluep).sval)->c_str ())); }
        break;

    case YYSYMBOL_RAW_DATA: /* "data"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %u"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_stream: /* stream  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %u"), ((*yyvaluep).ival)); }
        break;
...
yy_reduce_print (yybool yynormal, yyGLRStackItem* yyvsp, YYPTRDIFF_T yyk,
                 yyRuleNum yyrule, FTP_IParserData* driver, yyscan_t yyscanner);
...
static inline yysymbol_kind_t
yygetToken (int *yycharp, yyGLRStack* yystackp, FTP_IParserData* driver, yyscan_t yyscanner)
{
...
yyuserAction (yyRuleNum yyrule, int yyrhslen, yyGLRStackItem* yyvsp,
              ...
              YYSTYPE* yyvalp, YYLTYPE *yylocp, FTP_IParserData* driver, yyscan_t yyscanner)
{
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, FTP_IParserData* driver, yyscan_t yyscanner)
{
  YY_USE (yyvaluep);
  YY_USE (yylocationp);
  YY_USE (driver);
...
static void
yydestroyGLRState (char const *yymsg, yyGLRState *yys, FTP_IParserData* driver, yyscan_t yyscanner)
{
  if (yys->yyresolved)
...
yyglrReduce (yyGLRStack* yystackp, YYPTRDIFF_T yyk, yyRuleNum yyrule,
             yybool yyforceEval, FTP_IParserData* driver, yyscan_t yyscanner)
{
...
static YYRESULTTAG
yyresolveValue (yyGLRState* yys, yyGLRStack* yystackp, FTP_IParserData* driver, yyscan_t yyscanner);
...
yyresolveStates (yyGLRState* yys, int yyn,
                 yyGLRStack* yystackp, FTP_IParserData* driver, yyscan_t yyscanner)
{
  if (0 < yyn)
    {
...
yyreportAmbiguity (yySemanticOption* yyx0,
                   yySemanticOption* yyx1, YYLTYPE *yylocp, FTP_IParserData* driver, yyscan_t yyscanner)
{
  YY_USE (yyx0);
  YY_USE (yyx1);
...
static YYRESULTTAG
yyresolveStack (yyGLRStack* yystackp, FTP_IParserData* driver, yyscan_t yyscanner)
{
  if (yystackp->yysplitPoint != YY_NULLPTR)
    {
      yyGLRState* yys;
...
yyprocessOneStack (yyGLRStack* yystackp, YYPTRDIFF_T yyk,
                   YYPTRDIFF_T yyposn, YYLTYPE *yylocp, FTP_IParserData* driver, yyscan_t yyscanner)
{
...
static void
yyreportSyntaxError (yyGLRStack* yystackp, FTP_IParserData* driver, yyscan_t yyscanner)
{
...
/* Recover from a syntax error on *YYSTACKP, assuming that *YYSTACKP->YYTOKENP,
   ...
   of the lookahead.  */
static void
yyrecoverSyntaxError (yyGLRStack* yystackp, FTP_IParserData* driver, yyscan_t yyscanner)
{
...
int
yyparse (FTP_IParserData* driver, yyscan_t yyscanner)
{
  int yyresult;
  yyGLRStack yystack;
