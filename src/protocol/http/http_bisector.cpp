#line 1 "http_bisector.cpp"

#line 3 "http_bisector.cpp"
...
static const struct yy_trans_info yy_transition[1814] =
    {
...
/* %endif */
{
		...
		while ( num_to_read <= 0 )
			...
			if ( b->yy_is_our_buffer )
				...
				b->yy_ch_buf = (char *)
					...
					HTTP_Bisector_realloc((void *) b->yy_ch_buf,(yy_size_t) (b->yy_buf_size + 2) ,yyscanner );
				}
			else
	...
	if ((yyg->yy_n_chars + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) HTTP_Bisector_realloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,(yy_size_t) new_size ,yyscanner );
...
/* %endif */
{
	 ...
	 */
	b->yy_ch_buf = (char *) HTTP_Bisector_alloc((yy_size_t) (b->yy_buf_size + 2) ,yyscanner );
	if ( ! b->yy_ch_buf )
		YY_FATAL_ERROR( "out of dynamic memory in HTTP_Bisector__create_buffer()" );
 ...
 */
YY_BUFFER_STATE HTTP_Bisector__scan_string (const char * yystr , yyscan_t yyscanner)
{
    
	return HTTP_Bisector__scan_bytes(yystr,(int) strlen(yystr) ,yyscanner);
}
/* %endif */
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE HTTP_Bisector__scan_bytes  (const char * yybytes, int  _yybytes_len , yyscan_t yyscanner)
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
...
void HTTP_Bisector_set_debug (int  _bdebug , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
