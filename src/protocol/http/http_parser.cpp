...
{
      13,     0,    -1,    14,     7,    22,    -1,     3,    15,    -1,
       5,    18,    -1,     0,    -1,    16,    21,    -1,     4,    17,
      -1,     0,    -1,     5,    -1,     0,    -1,    19,    21,    -1,
       8,    20,    -1,     0,    -1,     9,    -1,     0,    -1,    21,
       6,    -1,    -1,    10,    -1,    11,    23,    21,     7,    -1,
      -1,    11,    23,    -1,    -1
};
...
static const char *const yytname[] =
{
  ...
  "status_line_rest1", "status_line_rest2", "headers", "body", "chunks", 0
};
#endif
...
#define YYLEX yylex (&yylval, &yylloc, driver, yyscanner)
  ...
  if (yydebug)								    \
    {									    \
      ...
      yy_symbol_print (stderr, Type,					    \
		       Value, Location, driver, yyscanner);  \
      YYFPRINTF (stderr, "\n");						    \
    }									    \
} while (YYID (0))
...
static void yyFail (yyGLRStack* yystackp, YYLTYPE *yylocp, Net_IParser<HTTP_Record>* driver, yyscan_t yyscanner, const char* yymsg)
...
yyuserAction (yyRuleNum yyn, int yyrhslen, yyGLRStackItem* yyvsp,
	      ...
	      yyGLRStack* yystackp
	      , Net_IParser<HTTP_Record>* driver, yyscan_t yyscanner)
{
...
# define YYBACKUP(Token, Value)						     \
  ...
  switch (yyn)
    ...
    { ((*yyvalp).ival) = (((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (3))].yystate.yysemantics.yysval.ival) + (((yyGLRStackItem const *)yyvsp)[YYFILL ((2) - (3))].yystate.yysemantics.yysval.ival) + (((yyGLRStackItem const *)yyvsp)[YYFILL ((3) - (3))].yystate.yysemantics.yysval.ival); }
    break;
  ...
  case 3:
    ...
    { ((*yyvalp).ival) = (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (2))].yystate.yysemantics.yysval.sval)).size () + (((yyGLRStackItem const *)yyvsp)[YYFILL ((2) - (2))].yystate.yysemantics.yysval.ival) + 1;
                                                       driver->record ()->method =
                                                         HTTP_Tools::Method2Type (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (2))].yystate.yysemantics.yysval.sval));
//                                                       ACE_DEBUG ((LM_DEBUG,
...
//                                                                   ACE_TEXT ((*$1).c_str ())));
  ...
  case 4:
    ...
    { ((*yyvalp).ival) = (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (2))].yystate.yysemantics.yysval.sval)).size () + (((yyGLRStackItem const *)yyvsp)[YYFILL ((2) - (2))].yystate.yysemantics.yysval.ival) + 1;
                                                       ...
                                                       if (!std::regex_match (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (2))].yystate.yysemantics.yysval.sval),
                                                                              match_results,
                                                                              regex,
                                                                              std::regex_constants::match_default))
                                                       {
                                                         ACE_DEBUG ((LM_ERROR,
                                                                     ...
                                                                     ACE_TEXT ((*(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (2))].yystate.yysemantics.yysval.sval)).c_str ())));
                                                       } // end IF
                                                       else
                                                       {
...
//                                                                     ACE_TEXT (match_results[1].str ().c_str ())));
  ...
  case 7:
    ...
    { ((*yyvalp).ival) = (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (2))].yystate.yysemantics.yysval.sval)).size () + (((yyGLRStackItem const *)yyvsp)[YYFILL ((2) - (2))].yystate.yysemantics.yysval.ival) + 1;
                                                       driver->record ()->URI = *(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (2))].yystate.yysemantics.yysval.sval);
//                                                       ACE_DEBUG ((LM_DEBUG,
//                                                                   ACE_TEXT ("set URI: \"%s\"\n"),
//                                                                   ACE_TEXT ((*$1).c_str ())));
                                                     }
  ...
  case 9:
    ...
    { ((*yyvalp).ival) = (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (1))].yystate.yysemantics.yysval.sval)).size () + 2;
                                                       driver->record ()->version =
                                                         HTTP_Tools::Version2Type (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (1))].yystate.yysemantics.yysval.sval));
//                                                       ACE_DEBUG ((LM_DEBUG,
//                                                                   ACE_TEXT ("set version: \"%s\"\n"),
//                                                                   ACE_TEXT ((*$1).c_str ())));
                                                     }
...
//                                                                   status));
  ...
  case 14:
    ...
    { ((*yyvalp).ival) = (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (1))].yystate.yysemantics.yysval.sval)).size () + 2;
                                                       driver->record ()->reason = *(((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (1))].yystate.yysemantics.yysval.sval);
//                                                       ACE_DEBUG ((LM_DEBUG,
...
//                                                                   ACE_TEXT ((*$1).c_str ())));
  ...
  case 16:
    ...
    { /* NOTE*: use right-recursion here to force early state reductions
                                                       ...
                                                       ((*yyvalp).ival) = (((yyGLRStackItem const *)yyvsp)[YYFILL ((1) - (2))].yystate.yysemantics.yysval.ival) + (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((2) - (2))].yystate.yysemantics.yysval.sval)).size ();
                                                       /* *TODO*: modify the scanner so it emits the proper fields itself */
                                                       std::string regex_string =
                                                         ACE_TEXT_ALWAYS_CHAR ("^([^:]+):\\s(.+)$");
                                                       std::regex regex (regex_string);
                                                       std::smatch match_results;
                                                       if (!std::regex_match (*(((yyGLRStackItem const *)yyvsp)[YYFILL ((2) - (2))].yystate.yysemantics.yysval.sval),
                                                                              match_results,
                                                                              regex,
                                                                              std::regex_constants::match_default))
                                                       {
  ...
  if (yys->yyresolved)
      ...
      if (yydebug)
	{
	  ...
	  yy_symbol_print (stderr, yystos[yys->yylrState],
			   NULL, &yys->yyloc, driver, yyscanner);
	  YYFPRINTF (stderr, "\n");
	}
#endif
  ...
  if (yystackp->yysplitPoint == NULL)
    {
      ...
      return yyuserAction (yyrule, yynrhs, rhs,
			   yyvalp, yylocp, yystackp, driver, yyscanner);
    }
  else
    {
  ...
  if (yyforceEval || yystackp->yysplitPoint == NULL)
    {
      ...
      YY_REDUCE_PRINT ((yystackp, yyk, yyrule, &yysval, &yyloc, driver, yyscanner));
      YYCHK (yydoAction (yystackp, yyk, yyrule, &yysval,
			 &yyloc, driver, yyscanner));
		 ...
		 YYSTYPE* yyvalp, YYLTYPE* yylocp, Net_IParser<HTTP_Record>* driver, yyscan_t yyscanner)
{
  ...
  yyflag = yyresolveStates (yyopt->yystate, yynrhs, yystackp, driver, yyscanner);
  if (yyflag != yyok)
    {
      yyGLRState *yys;
		   ...
		   size_t yyposn, YYLTYPE *yylocp, Net_IParser<HTTP_Record>* driver, yyscan_t yyscanner)
{
  ...
  while (yystackp->yytops.yystates[yyk] != NULL)
      ...
      if (yyisDefaultedState (yystate))
	{
	  ...
	  YYCHK (yyglrReduce (yystackp, yyk, yyrule, yyfalse, driver, yyscanner));
	}
      else
	{
	  yySymbol yytoken;
	  ...
	  while (*yyconflicts != 0)
	    {
	      ...
	      YYCHK (yyglrReduce (yystackp, yynewStack,
				  *yyconflicts, yyfalse, driver, yyscanner));
...
yyrecoverSyntaxError (yyGLRStack* yystackp, Net_IParser<HTTP_Record>* driver, yyscan_t yyscanner)
{
  ...
  if (yystackp->yyerrState == 3)
	...
	yySymbol yytoken;
	if (yychar == YYEOF)
	  yyFail (yystackp, &yylloc, driver, yyscanner, NULL);
	if (yychar != YYEMPTY)
	  {
 ...
 yyreturn:
  if (yychar != YYEMPTY)
    yydestruct ("Cleanup: discarding lookahead",
		YYTRANSLATE (yychar),
		&yylval, &yylloc, driver, yyscanner);
