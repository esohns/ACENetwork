...
{
      -2,     4,     1,     2,     3,     6,   -12,   -12,     5,   -12,
     -12,   -12,    -6,   -12,   -12,     7,   -12,   -12,     7,   -12,
       8,   -12,   -12,     8,   -12,   -12,   -12,     0,   -12
};
...
{
      18,     1,    11,     2,    19,    20,    22,    28,     5,     8,
      12,    13,    26,    22,    16,    27,     0,     0,     0,    23
};

static const signed char yycheck[] =
{
      10,     3,     0,     5,    10,    11,     6,     7,     4,     8,
       7,     5,    23,     6,     9,    25,    -1,    -1,    -1,    11
};
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
...
yyFail (yyGLRStack* yystackp, HTTP_IParser* iparser_p, yyscan_t yyscanner, const char* yymsg)
{
  if (yymsg != YY_NULLPTR)
    yyerror (iparser_p, yyscanner, yymsg);
...
# define YYBACKUP(Token, Value)                                              \
  return yyerror (iparser_p, yyscanner, YY_("syntax error: cannot back up")),     \
         yyerrok, yyerr
  ...
  case 3:
    ...
    { ((*yyvalp).ival) = (((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.sval)->size () + (((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.ival) + 1;
                                                       struct HTTP_Record& record_r =
                                                         iparser_p->current ();
                                                       record_r.method =
                                                         HTTP_Tools::MethodToType (*(((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.sval));
                                                     }
...
//                                                       ACE_ASSERT (match_results.ready () && !match_results.empty ());
  ...
  case 6:
    ...
    { ((*yyvalp).ival) = (((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.sval)->size () + (((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.ival) + 1;
                                                       struct HTTP_Record& record_r =
                                                         iparser_p->current ();
                                                       record_r.URI = *(((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.sval);
                                                     }
  ...
  case 7:
    ...
    { ((*yyvalp).ival) = (((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.sval)->size () + 2;
                                                       struct HTTP_Record& record_r =
                                                         iparser_p->current ();
                                                       record_r.version =
                                                         HTTP_Tools::VersionToType (*(((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.sval));
                                                     }
  ...
  case 10:
    ...
    { ((*yyvalp).ival) = (((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.sval)->size () + 2;
                                                       struct HTTP_Record& record_r =
                                                         iparser_p->current ();
                                                       record_r.reason = *(((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.sval);
                                                     }
...
//                                                       ACE_ASSERT (match_results.ready () && !match_results.empty ());
  ...
  case 13:
    ...
    { ((*yyvalp).ival) = (((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.ival);
                                                       ...
                                                       if ((((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.ival) == static_cast<int> (content_length))
                                                       {
  ...
  case 15:
    ...
    { ((*yyvalp).ival) = (((yyGLRStackItem const *)yyvsp)[YYFILL (-2)].yystate.yysemantics.yysval.ival) + (((yyGLRStackItem const *)yyvsp)[YYFILL (-1)].yystate.yysemantics.yysval.ival) + (((yyGLRStackItem const *)yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.ival); // *TODO*: potential conflict here (i.e. incomplete chunk may be accepted)
                                                     struct HTTP_Record& record_r =
                                                       iparser_p->current ();
                                                     struct HTTP_Record* record_p =
                                                       &record_r;
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (iparser_p);
...
static void
yydestroyGLRState (char const *yymsg, yyGLRState *yys, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  if (yys->yyresolved)
...
yyglrReduce (yyGLRStack* yystackp, size_t yyk, yyRuleNum yyrule,
             yybool yyforceEval, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
...
yyreportAmbiguity (yySemanticOption* yyx0,
                   yySemanticOption* yyx1, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  YYUSE (yyx0);
  YYUSE (yyx1);
  ...
  yyerror (iparser_p, yyscanner, YY_("syntax is ambiguous"));
  return yyabort;
}
      ...
      else
        {
          switch (yypreference (yybest, yyp))
            ...
            case 0:
              ...
              return yyreportAmbiguity (yybest, yyp, iparser_p, yyscanner);
              break;
            case 1:
              yymerge = yytrue;
              break;
...
static YYRESULTTAG
yyresolveStack (yyGLRStack* yystackp, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  if (yystackp->yysplitPoint != YY_NULLPTR)
    {
      yyGLRState* yys;
...
yyprocessOneStack (yyGLRStack* yystackp, size_t yyk,
                   size_t yyposn, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
...
static void
yyreportSyntaxError (yyGLRStack* yystackp, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  if (yystackp->yyerrState != 0)
    return;
#if ! YYERROR_VERBOSE
  yyerror (iparser_p, yyscanner, YY_("syntax error"));
#else
  {
...
/* Recover from a syntax error on *YYSTACKP, assuming that *YYSTACKP->YYTOKENP,
   ...
   of the lookahead.  */
static void
yyrecoverSyntaxError (yyGLRStack* yystackp, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  size_t yyk;
  int yyj;
    ...
    while (yytrue)
      {
        yySymbol yytoken;
        if (yychar == YYEOF)
          yyFail (yystackp, iparser_p, yyscanner, YY_NULLPTR);
        if (yychar != YYEMPTY)
          {
...
int
yyparse (HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  int yyresult;
  yyGLRStack yystack;
  ...
  
{
      ...
      while (yytrue)
        {
          ...
          for (yys = 0; yys < yystack.yytops.yysize; yys += 1)
            YYCHK1 (yyprocessOneStack (&yystack, yys, yyposn, iparser_p, yyscanner));
          yyremoveDeletes (&yystack);
          if (yystack.yytops.yysize == 0)
            {
              yyundeleteLastStack (&yystack);
              if (yystack.yytops.yysize == 0)
                yyFail (&yystack, iparser_p, yyscanner, YY_("syntax error"));
 ...
 yyexhaustedlab:
  yyerror (iparser_p, yyscanner, YY_("memory exhausted"));
  yyresult = 2;
  goto yyreturn;
