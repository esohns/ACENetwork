...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  YYFPRINTF (yyo, "%s %s (",
  ...
  YYFPRINTF (yyo, ": ");
  yy_symbol_value_print (yyo, yytype, yyvaluep, yylocationp, iparser_p, yyscanner);
  YYFPRINTF (yyo, ")");
}
...
yyFail (yyGLRStack* yystackp, YYLTYPE *yylocp, HTTP_IParser* iparser_p, yyscan_t yyscanner, const char* yymsg)
{
  if (yymsg != YY_NULLPTR)
  ...
  if (*yycharp == YYEMPTY)
    {
      ...
      *yycharp = yylex (&yylval, &yylloc, iparser_p, yyscanner);
    }
  if (*yycharp <= YYEOF)
    {
...
//                                                       ACE_ASSERT (match_results.ready () && !match_results.empty ());
  ...
  case 13:
                                                     { ((*yyvalp).ival) = (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.ival);
                                                       ...
                                                       if ((YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yysval.ival) == static_cast<int> (content_length))
                                                       {
...
yyprocessOneStack (yyGLRStack* yystackp, ptrdiff_t yyk,
                   ptrdiff_t yyposn, YYLTYPE *yylocp, HTTP_IParser* iparser_p, yyscan_t yyscanner)
{
  while (yystackp->yytops.yystates[yyk] != YY_NULLPTR)
    {
      ...
      if (yyisDefaultedState (yystate))
        ...
        {
          yySymbol yytoken = yygetToken (&yychar, yystackp, iparser_p, yyscanner);
    ...
    while (yytrue)
      {
        ...
        yytoken = yygetToken (&yychar, yystackp, iparser_p, yyscanner);
          ...
          if (yyisDefaultedState (yystate))
          ...
          else
            {
              ...
              if (yyisShiftAction (yyaction))
                ...
                {
                  yystack.yyerror_range[1].yystate.yyloc = yylloc;                  yyreportSyntaxError (&yystack, iparser_p, yyscanner);
                  goto yyuser_error;
                }
              else
