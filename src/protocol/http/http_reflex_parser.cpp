...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_URI = 4,                        /* "uri"  */
  YYSYMBOL__VERSION = 5,                   /* "version"  */
  YYSYMBOL_HEADER = 6,                     /* "header"  */
  YYSYMBOL_DELIMITER = 7,                  /* "delimiter"  */
  YYSYMBOL_STATUS = 8,                     /* "status"  */
  YYSYMBOL_REASON = 9,                     /* "reason"  */
  YYSYMBOL_BODY = 10,                      /* "body"  */
  YYSYMBOL_CHUNK = 11,                     /* "chunk"  */
...
# if defined HTTP_LTYPE_IS_TRIVIAL && HTTP_LTYPE_IS_TRIVIAL
  = { 1, 1, 1, 1 }
# endif
;
...
{
       0,   169,   169,   169,   185,   191,   219,   220,   225,   254,
     255,   265,   270,   311,   313,   334,   334,   343,   365,   378,
     378,   387
};
#endif
...
#define http_nerrs yynerrs
#define http_char yychar
#define http_lval yylval
#define http_lloc yylloc
...
yyFail (yyGLRStack* yystackp, YYLTYPE *yylocp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner, const char* yymsg)
{
  if (yymsg != YY_NULLPTR)
    yyerror (yylocp, iparser_p, scanner, yymsg);
...
#  elif defined HTTP_LTYPE_IS_TRIVIAL && HTTP_LTYPE_IS_TRIVIAL
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yylocationp);
  ...
  switch (yykind)
    ...
    case YYSYMBOL_YYEOF: /* "end"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;
    ...
    case YYSYMBOL__VERSION: /* "version"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("\"%s\""), (*((*yyvaluep).sval)).c_str ()); }
        break;
    ...
    case YYSYMBOL_DELIMITER: /* "delimiter"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_STATUS: /* "status"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("\"%s\""), (*((*yyvaluep).sval)).c_str ()); }
        break;

    case YYSYMBOL_REASON: /* "reason"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("\"%s\""), (*((*yyvaluep).sval)).c_str ()); }
        break;
    ...
    case YYSYMBOL_END_OF_FRAGMENT: /* "end_of_fragment"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;
    ...
    case YYSYMBOL_head: /* head  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_head_rest1: /* head_rest1  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_request_line_rest1: /* request_line_rest1  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_request_line_rest2: /* request_line_rest2  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_head_rest2: /* head_rest2  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_status_line_rest1: /* status_line_rest1  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_status_line_rest2: /* status_line_rest2  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_headers: /* headers  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;
    ...
    case YYSYMBOL_chunked_body: /* chunked_body  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT ("%q"), ((*yyvaluep).ival)); }
        break;
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  ...
  YYFPRINTF (yyo, ": ");
  yy_symbol_value_print (yyo, yykind, yyvaluep, yylocationp, iparser_p, scanner);
  YYFPRINTF (yyo, ")");
}
  ...
  do {                                                                  \
    if (yydebug)                                                        \
      {                                                                 \
        ...
        yy_symbol_print (stderr, Kind, Value, Location, iparser_p, scanner);        \
        YY_FPRINTF ((stderr, "\n"));                                    \
      }                                                                 \
  } while (0)
...
yy_reduce_print (yybool yynormal, yyGLRStackItem* yyvsp, YYPTRDIFF_T yyk,
                 yyRuleNum yyrule, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner);
...
static inline yysymbol_kind_t
yygetToken (int *yycharp, yyGLRStack* yystackp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  yysymbol_kind_t yytoken;
  YY_USE (iparser_p);
  YY_USE (scanner);
  if (*yycharp == HTTP_EMPTY)
    {
...
yyuserAction (yyRuleNum yyrule, int yyrhslen, yyGLRStackItem* yyvsp,
              ...
              YYSTYPE* yyvalp, YYLTYPE *yylocp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
...
# undef yyclearin
# define yyclearin (yychar = HTTP_EMPTY)
# undef YYFILL
# define YYFILL(N) yyfill (yyvsp, &yylow, (N), yynormal)
# undef YYBACKUP
# define YYBACKUP(Token, Value)                                              \
  return yyerror (yylocp, iparser_p, scanner, YY_("syntax error: cannot back up")),     \
         yyerrok, yyerr
  ...
  YY_REDUCE_PRINT ((yynormal || yyk == -1, yyvsp, yyk, yyrule, iparser_p, scanner));
  switch (yyrule)
    {
  case 2: /* $@1: %empty  */
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  YY_USE (yyvaluep);
  YY_USE (yylocationp);
  YY_USE (iparser_p);
...
static void
yydestroyGLRState (char const *yymsg, yyGLRState *yys, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  if (yys->yyresolved)
    yydestruct (yymsg, yy_accessing_symbol (yys->yylrState),
                &yys->yysemantics.yyval, &yys->yyloc, iparser_p, scanner);
  else
    {
#if HTTP_DEBUG
      if (yydebug)
      ...
      if (yys->yysemantics.yyfirstVal)
        {
          ...
          for (yyrh = yyoption->yystate, yyn = yyrhsLength (yyoption->yyrule);
            ...
            yydestroyGLRState (yymsg, yyrh, iparser_p, scanner);
        }
    }
}
                     ...
                     yyGLRState* yyrhs, yyRuleNum yyrule)
{
  ...
  if (yystackp->yytops.yylookaheadNeeds[yyk])
    ...
    yynewOption->yyrawchar = HTTP_EMPTY;
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &(YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL ((yyi + 1) - (yynrhs))].yystate.yyloc)                       , iparser_p, scanner);
  ...
  if (yystackp->yysplitPoint == YY_NULLPTR)
    {
      ...
      return yyuserAction (yyrule, yynrhs, yyrhs, yystackp, yyk,
                           yyvalp, yylocp, iparser_p, scanner);
    }
  else
    {
      ...
      return yyuserAction (yyrule, yynrhs, yyrhsVals + YYMAXRHS + YYMAXLEFT - 1,
                           yystackp, yyk, yyvalp, yylocp, iparser_p, scanner);
    }
}
...
yyglrReduce (yyGLRStack* yystackp, YYPTRDIFF_T yyk, yyRuleNum yyrule,
             yybool yyforceEval, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  ...
  if (yyforceEval || yystackp->yysplitPoint == YY_NULLPTR)
    {
      ...
      YYRESULTTAG yyflag = yydoAction (yystackp, yyk, yyrule, &yyval, &yyloc, iparser_p, scanner);
...
static YYRESULTTAG
yyresolveValue (yyGLRState* yys, yyGLRStack* yystackp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner);
...
yyresolveStates (yyGLRState* yys, int yyn,
                 yyGLRStack* yystackp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  if (0 < yyn)
    {
      YY_ASSERT (yys->yypred);
      YYCHK (yyresolveStates (yys->yypred, yyn-1, yystackp, iparser_p, scanner));
      if (! yys->yyresolved)
        YYCHK (yyresolveValue (yys, yystackp, iparser_p, scanner));
    }
  return yyok;
}
                 ...
                 YYSTYPE* yyvalp, YYLTYPE *yylocp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  ...
  YYRESULTTAG yyflag =
    yyresolveStates (yyopt->yystate, yynrhs, yystackp, iparser_p, scanner);
  if (yyflag != yyok)
    {
      yyGLRState *yys;
      for (yys = yyopt->yystate; yynrhs > 0; yys = yys->yypred, yynrhs -= 1)
        yydestroyGLRState ("Cleanup: popping", yys, iparser_p, scanner);
      return yyflag;
    }
    ...
    yyrhsVals[YYMAXRHS + YYMAXLEFT - 1].yystate.yyloc = yyopt->yystate->yyloc;
  {
    ...
    yyflag = yyuserAction (yyopt->yyrule, yynrhs,
                           ...
                           yystackp, -1, yyvalp, yylocp, iparser_p, scanner);
...
yyreportAmbiguity (yySemanticOption* yyx0,
                   yySemanticOption* yyx1, YYLTYPE *yylocp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  YY_USE (yyx0);
  YY_USE (yyx1);
  ...
  yyerror (yylocp, iparser_p, scanner, YY_("syntax is ambiguous"));
  return yyabort;
}
                    ...
                    yyGLRStack *yystackp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  if (0 < yyn1)
    {
      yyresolveLocations (yys1->yypred, yyn1 - 1, yystackp, iparser_p, scanner);
      if (!yys1->yyresolved)
        {
      ...
      if (yyidenticalOptions (yybest, yyp))
      ...
      else
        {
          switch (yypreference (yybest, yyp))
            {
            case 0:
              yyresolveLocations (yys, 1, yystackp, iparser_p, scanner);
              return yyreportAmbiguity (yybest, yyp, yylocp, iparser_p, scanner);
              break;
            case 1:
              yymerge = yytrue;
              break;
  ...
  if (yymerge)
    {
      ...
      yyflag = yyresolveAction (yybest, yystackp, &yyval, yylocp, iparser_p, scanner);
      if (yyflag == yyok)
            ...
            if (yyprec == yydprec[yyp->yyrule])
              {
                YYSTYPE yyval_other;
                YYLTYPE yydummy;
                yyflag = yyresolveAction (yyp, yystackp, &yyval_other, &yydummy, iparser_p, scanner);
                if (yyflag != yyok)
                  {
                    yydestruct ("Cleanup: discarding incompletely merged value for",
                                yy_accessing_symbol (yys->yylrState),
                                &yyval, yylocp, iparser_p, scanner);
                    break;
                  }
...
static YYRESULTTAG
yyresolveStack (yyGLRStack* yystackp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  if (yystackp->yysplitPoint != YY_NULLPTR)
    {
      yyGLRState* yys;
...
yyprocessOneStack (yyGLRStack* yystackp, YYPTRDIFF_T yyk,
                   YYPTRDIFF_T yyposn, YYLTYPE *yylocp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
      ...
      if (yyisDefaultedState (yystate))
        {
          ...
          yyflag = yyglrReduce (yystackp, yyk, yyrule, yyimmediate[yyrule], iparser_p, scanner);
          if (yyflag == yyerr)
            {
              YY_DPRINTF ((stderr,
                           "Stack %ld dies "
        ...
        {
          yysymbol_kind_t yytoken = yygetToken (&yychar, yystackp, iparser_p, scanner);
          ...
          for (/* nothing */; *yyconflicts; yyconflicts += 1)
            {
              ...
              yyflag = yyglrReduce (yystackp, yynewStack,
                                    *yyconflicts,
                                    yyimmediate[*yyconflicts], iparser_p, scanner);
              if (yyflag == yyok)
                YYCHK (yyprocessOneStack (yystackp, yynewStack,
                                          yyposn, yylocp, iparser_p, scanner));
          ...
          if (yyisShiftAction (yyaction))
          ...
          else
            {
              YYRESULTTAG yyflag = yyglrReduce (yystackp, yyk, -yyaction,
                                                yyimmediate[-yyaction], iparser_p, scanner);
              if (yyflag == yyerr)
                {
                  YY_DPRINTF ((stderr,
                               "Stack %ld dies "
...
yy_syntax_error_arguments (const yyGLRStack* yystackp,
                           yysymbol_kind_t yyarg[], int yyargn)
{
  yysymbol_kind_t yytoken = yychar == HTTP_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
  /* Actual size of YYARG. */
  int yycount = 0;
...
static void
yyreportSyntaxError (yyGLRStack* yystackp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  ...
  if (yymsg)
    {
      ...
      yyerror (&yylloc, iparser_p, scanner, yymsg);
      YYFREE (yymsg);
    }
  else
    {
      yyerror (&yylloc, iparser_p, scanner, YY_("syntax error"));
      yyMemoryExhausted (yystackp);
    }
  }
  yynerrs += 1;
...
/* Recover from a syntax error on *YYSTACKP, assuming that *YYSTACKP->YYTOKENP,
   ...
   of the lookahead.  */
static void
yyrecoverSyntaxError (yyGLRStack* yystackp, HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
    ...
    while (yytrue)
      {
        ...
        int yyj;
        if (yychar == END)
          yyFail (yystackp, &yylloc, iparser_p, scanner, YY_NULLPTR);
        if (yychar != HTTP_EMPTY)
          {
            ...
            yydestruct ("Error: discarding",
                        yytoken, &yylval, &yylloc, iparser_p, scanner);
            yychar = HTTP_EMPTY;
          }
        yytoken = yygetToken (&yychar, yystackp, iparser_p, scanner);
  ...
  while (yystackp->yytops.yystates[0] != YY_NULLPTR)
    {
      ...
      if (yys->yypred != YY_NULLPTR)
        yydestroyGLRState ("Error: popping", yys, iparser_p, scanner);
...
int
yyparse (HTTP_Reflex_IParser* iparser_p, yyscan_t scanner)
{
  int yyresult;
  yyGLRStack yystack;
  ...
  /* User initialization code.  */
{
  ...
  while (yytrue)
    {
              ...
              if (yyrule == 0)
                {
                  ...
                  yyreportSyntaxError (&yystack, iparser_p, scanner);
                  goto yyuser_error;
                }
              YYCHK1 (yyglrReduce (&yystack, 0, yyrule, yytrue, iparser_p, scanner));
            }
          else
            {
              yysymbol_kind_t yytoken = yygetToken (&yychar, yystackp, iparser_p, scanner);
              ...
              if (yyisShiftAction (yyaction))
              ...
              else if (yyisErrorAction (yyaction))
                {
                  ...
                  /* Issue an error message unless the scanner already
                     did. */
                  if (yychar != HTTP_error)
                    yyreportSyntaxError (&yystack, iparser_p, scanner);
                  goto yyuser_error;
                }
              else
                YYCHK1 (yyglrReduce (&yystack, 0, -yyaction, yytrue, iparser_p, scanner));
            }
        }
      ...
      while (yytrue)
        {
          ...
          for (yys = 0; yys < yystack.yytops.yysize; yys += 1)
            yystackp->yytops.yylookaheadNeeds[yys] = yychar != HTTP_EMPTY;
          ...
          for (yys = 0; yys < yystack.yytops.yysize; yys += 1)
            YYCHK1 (yyprocessOneStack (&yystack, yys, yyposn, &yylloc, iparser_p, scanner));
          yyremoveDeletes (&yystack);
          if (yystack.yytops.yysize == 0)
            {
              yyundeleteLastStack (&yystack);
              if (yystack.yytops.yysize == 0)
                yyFail (&yystack, &yylloc, iparser_p, scanner, YY_("syntax error"));
              YYCHK1 (yyresolveStack (&yystack, iparser_p, scanner));
          ...
          /* If any yyglrShift call fails, it will fail after shifting.  Thus,
             ...
             failure in the following loop.  Thus, yychar is set to HTTP_EMPTY
      ...
      continue;
    yyuser_error:
      yyrecoverSyntaxError (&yystack, iparser_p, scanner);
 ...
 yyexhaustedlab:
  yyerror (&yylloc, iparser_p, scanner, YY_("memory exhausted"));
  yyresult = 2;
  goto yyreturnlab;
 ...
 yyreturnlab:
  if (yychar != HTTP_EMPTY)
    yydestruct ("Cleanup: discarding lookahead",
                YYTRANSLATE (yychar), &yylval, &yylloc, iparser_p, scanner);
...
#define yylex   http_lex
#define yyerror http_error
#define yylval  http_lval
#define yychar  http_char
#define yydebug http_debug
#define yynerrs http_nerrs
#define yylloc  http_lloc
...
void
http_error (YYLTYPE* location_in,
            HTTP_Reflex_IParser* iparser_in,
            yyscan_t context_in,
            const char* message_in)
{
  NETWORK_TRACE (ACE_TEXT ("::http_error"));
