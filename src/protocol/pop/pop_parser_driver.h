...
#ifndef POP_PARSER_DRIVER_T_H
#define POP_PARSER_DRIVER_T_H
...
class POP_ParserDriver_T
 : public POP_IParser
{
  //friend class POP_Scanner;

 public:
  POP_ParserDriver_T ();
  virtual ~POP_ParserDriver_T ();
...
//  virtual bool debug () const = 0;
  ...
  virtual bool initialize (yyscan_t&,             // return value: state handle
                           POP_IParser* = NULL); // 'extra' data handle
