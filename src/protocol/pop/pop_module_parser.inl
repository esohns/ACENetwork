...
POP_Module_Parser_T<ACE_SYNCH_USE,
                     TimePolicyType,
                     ConfigurationType,
                     ControlMessageType,
                     DataMessageType,
#if defined (ACE_WIN32) || defined (ACE_WIN64)
                     SessionMessageType>::POP_Module_Parser_T (ISTREAM_T* stream_in)
#else
                     SessionMessageType>::POP_Module_Parser_T (typename inherited::ISTREAM_T* stream_in)
#endif // ACE_WIN32 || ACE_WIN64
 : inherited (stream_in)
{
  NETWORK_TRACE (ACE_TEXT ("POP_Module_Parser_T::POP_Module_Parser_T"));
...
POP_Module_Parser_T<ACE_SYNCH_USE,
                     ...
                     ControlMessageType,
                     DataMessageType,
                     SessionMessageType>::record (struct POP_Record*& record_inout)
{
  NETWORK_TRACE (ACE_TEXT ("POP_Module_Parser_T::record"));
...
POP_Module_ParserH_T<ACE_SYNCH_USE,
 ...
 : inherited (stream_in)
{
  NETWORK_TRACE (ACE_TEXT ("POP_Module_ParserH_T::POP_Module_ParserH_T"));
