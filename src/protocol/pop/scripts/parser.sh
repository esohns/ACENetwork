...
SCRIPTS_DIRECTORY=${PROJECT_ROOT}/src/protocol/pop/scripts
...
#TARGET_FILE=${TARGET_DIRECTORY}/pcp_parser.h
#[ ! -f ${SOURCE_FILE} ] && echo "ERROR: file ${SOURCE_FILE} not found, aborting" && exit 1
...
FILES="pop_parser.h pop_parser.cpp"
#location.hh
#position.hh
#stack.hh"
