...
#ifndef YY_YY_POP_PARSER_H_INCLUDED
# define YY_YY_POP_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 1
#endif
...
int yyparse (POP_IParser* driver, yyscan_t yyscanner);

#endif /* !YY_YY_POP_PARSER_H_INCLUDED  */
