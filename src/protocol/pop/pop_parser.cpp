...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_REPLY_CODE = 3,                 /* "reply_code"  */
  YYSYMBOL_REPLY_TEXT = 4,                 /* "text"  */
  YYSYMBOL_REPLY_TEXT_END = 5,             /* "text_end"  */
  YYSYMBOL_YYACCEPT = 6,                   /* $accept  */
  YYSYMBOL_message = 7,                    /* message  */
  YYSYMBOL_8_1 = 8,                        /* $@1  */
  YYSYMBOL_text_lines = 9,                 /* text_lines  */
...
yyFail (yyGLRStack* yystackp, YYLTYPE *yylocp, POP_IParser* driver, yyscan_t yyscanner, const char* yymsg)
{
  if (yymsg != YY_NULLPTR)
...
{
  "\"end\"", "error", "\"invalid token\"", "\"reply_code\"", "\"text\"",
  "\"text_end\"", "$accept", "message", "$@1", "text_lines", "text_line", YY_NULLPTR
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, POP_IParser* driver, yyscan_t yyscanner)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yylocationp);
  ...
  switch (yykind)
    ...
    case YYSYMBOL_REPLY_CODE: /* "reply_code"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %s"), (((*yyvaluep).sval)->c_str ())); }
        break;

    case YYSYMBOL_REPLY_TEXT: /* "text"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %s"), (((*yyvaluep).sval)->c_str ())); }
        break;

    case YYSYMBOL_REPLY_TEXT_END: /* "text_end"  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %u"), ((*yyvaluep).ival)); }
        break;
    ...
    case YYSYMBOL_text_lines: /* text_lines  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %u"), ((*yyvaluep).ival)); }
        break;

    case YYSYMBOL_text_line: /* text_line  */
                          { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %u"), ((*yyvaluep).ival)); }
        break;
...
yy_reduce_print (yybool yynormal, yyGLRStackItem* yyvsp, YYPTRDIFF_T yyk,
                 yyRuleNum yyrule, POP_IParser* driver, yyscan_t yyscanner);
...
static inline yysymbol_kind_t
yygetToken (int *yycharp, yyGLRStack* yystackp, POP_IParser* driver, yyscan_t yyscanner)
{
...
yyuserAction (yyRuleNum yyrule, int yyrhslen, yyGLRStackItem* yyvsp,
              ...
              YYSTYPE* yyvalp, YYLTYPE *yylocp, POP_IParser* driver, yyscan_t yyscanner)
{
...
# define YYBACKUP(Token, Value)                                              \
  ...
  switch (yyrule)
    {
  case 2: /* $@1: %empty  */
                                                                    { driver->current ().status = (*(YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.sval)); }
    break;

  case 3: /* message: "reply_code" $@1 text_lines "text_end"  */
  ...
  case 4: /* text_lines: text_lines text_line  */
                                                                    { ((*yyvalp).ival) = (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-1)].yystate.yysemantics.yyval.ival) + (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.ival); }
    break;
  ...
  case 6: /* text_line: "text"  */
                                                                    { ((*yyvalp).ival) = static_cast<ACE_UINT32> ((YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.sval)->size ()) + 2;
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, POP_IParser* driver, yyscan_t yyscanner)
{
  YY_USE (yyvaluep);
  YY_USE (yylocationp);
  YY_USE (driver);
...
static void
yydestroyGLRState (char const *yymsg, yyGLRState *yys, POP_IParser* driver, yyscan_t yyscanner)
{
  if (yys->yyresolved)
...
yyglrReduce (yyGLRStack* yystackp, YYPTRDIFF_T yyk, yyRuleNum yyrule,
             yybool yyforceEval, POP_IParser* driver, yyscan_t yyscanner)
{
...
static YYRESULTTAG
yyresolveValue (yyGLRState* yys, yyGLRStack* yystackp, POP_IParser* driver, yyscan_t yyscanner);
...
yyresolveStates (yyGLRState* yys, int yyn,
                 yyGLRStack* yystackp, POP_IParser* driver, yyscan_t yyscanner)
{
  if (0 < yyn)
    {
...
yyreportAmbiguity (yySemanticOption* yyx0,
                   yySemanticOption* yyx1, YYLTYPE *yylocp, POP_IParser* driver, yyscan_t yyscanner)
{
  YY_USE (yyx0);
  YY_USE (yyx1);
...
static YYRESULTTAG
yyresolveStack (yyGLRStack* yystackp, POP_IParser* driver, yyscan_t yyscanner)
{
  if (yystackp->yysplitPoint != YY_NULLPTR)
    {
      yyGLRState* yys;
...
yyprocessOneStack (yyGLRStack* yystackp, YYPTRDIFF_T yyk,
                   YYPTRDIFF_T yyposn, YYLTYPE *yylocp, POP_IParser* driver, yyscan_t yyscanner)
{
...
static void
yyreportSyntaxError (yyGLRStack* yystackp, POP_IParser* driver, yyscan_t yyscanner)
{
...
/* Recover from a syntax error on *YYSTACKP, assuming that *YYSTACKP->YYTOKENP,
   ...
   of the lookahead.  */
static void
yyrecoverSyntaxError (yyGLRStack* yystackp, POP_IParser* driver, yyscan_t yyscanner)
{
...
int
yyparse (POP_IParser* driver, yyscan_t yyscanner)
{
  int yyresult;
  yyGLRStack yystack;
