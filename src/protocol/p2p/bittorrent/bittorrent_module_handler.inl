...
BitTorrent_Module_PeerHandler_T<AddressType,
                                ...
                                StreamStatusType,
                                SessionStateType,
                                CBDataType>::handleDataMessage (BitTorrent_Message_T<SessionDataType>*& message_inout,
...
BitTorrent_Module_PeerHandler_T<AddressType,
                                ...
                                StreamStatusType,
                                SessionStateType,
                                CBDataType>::handleSessionMessage (BitTorrent_SessionMessage_T<SessionDataType>*& message_inout,
                                                                   bool& passMessageDownstream_out)
{
                                                     ...
                                                     const BitTorrent_Message_T<SessionDataType>& message_in)
{
  ...
  try {
    session_->notify (record_r,
                      ((record_r.type == BITTORRENT_MESSAGETYPE_PIECE) ? &const_cast<BitTorrent_Message_T<SessionDataType>&> (message_in)
                                                                       : NULL));
  } catch (...) {
    ACE_DEBUG ((LM_ERROR,
