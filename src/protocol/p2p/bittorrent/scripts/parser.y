...
%printer    { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %s"), BitTorrent_Tools::HandShake2String (*$$).c_str ()); } <handshake>
%printer    { ACE_OS::fprintf (yyoutput, ACE_TEXT (" %s"), BitTorrent_Tools::Record2String (*$$).c_str ()); } <record>
