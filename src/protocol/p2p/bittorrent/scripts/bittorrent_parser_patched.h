...
namespace yy {
  ...
  unsigned int                     size;
    ...
    HANDSHAKE = 258,               // "handshake"
    BITFIELD = 259,                // "bitfield"
    CANCEL = 260,                  // "cancel"
    CHOKE = 261,                   // "choke"
    HAVE = 262,                    // "have"
    INTERESTED = 263,              // "interested"
    KEEP_ALIVE = 264,              // "keep-alive"
    NOT_INTERESTED = 265,          // "not_interested"
    PIECE = 266,                   // "piece"
    PORT = 267,                    // "port"
    REQUEST = 268,                 // "request"
    UNCHOKE = 269,                 // "unchoke"
    END_OF_FRAGMENT = 270          // "end_of_fragment"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_HANDSHAKE = 3,                         // "handshake"
        S_BITFIELD = 4,                          // "bitfield"
        S_CANCEL = 5,                            // "cancel"
        S_CHOKE = 6,                             // "choke"
        S_HAVE = 7,                              // "have"
        S_INTERESTED = 8,                        // "interested"
        S_KEEP_ALIVE = 9,                        // "keep-alive"
        S_NOT_INTERESTED = 10,                   // "not_interested"
        S_PIECE = 11,                            // "piece"
        S_PORT = 12,                             // "port"
        S_REQUEST = 13,                          // "request"
        S_UNCHOKE = 14,                          // "unchoke"
    ...
    struct basic_symbol : Base
    {
      ...
      {
        return BitTorrent_Parser::symbol_name (this->kind ());
      }
    ...
    BitTorrent_Parser (BitTorrent_IParser_t* parser_yyarg, yyscan_t scanner_yyarg);
    virtual ~BitTorrent_Parser ();

#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    BitTorrent_Parser (const BitTorrent_Parser&) = delete;
    /// Non copyable.
    BitTorrent_Parser& operator= (const BitTorrent_Parser&) = delete;
#endif
    ...
    {
    public:
      context (const BitTorrent_Parser& yyparser, const symbol_type& yyla);
    ...
    private:
      const BitTorrent_Parser& yyparser_;
...
#if YY_CPLUSPLUS < 201103L
    /// Non copyable.
    BitTorrent_Parser (const BitTorrent_Parser&);
    /// Non copyable.
    BitTorrent_Parser& operator= (const BitTorrent_Parser&);
#endif
