...
BitTorrent_Session_T<ConnectionType,
                     SessionDataType,
                     NotificationType,
                     ConfigurationType,
                     SessionMessageType,
                     ...
                     LogOutputType>::BitTorrent_Session_T (ConnectionManagerType* interfaceHandle_in,
                                                           unsigned int statisticCollectionInterval_in)
 : inherited (interfaceHandle_in,
              statisticCollectionInterval_in)
 , close_ (false)
 , inputHandler_ (NULL)
 , logToFile_ (BITTORRENT_SESSION_DEF_LOG)
...
BitTorrent_Session_T<ConnectionType,
              ...
              InputHandlerType,
              InputHandlerConfigurationType,
              LogOutputType>::~BitTorrent_Session_T ()
{
  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Session_T::~BitTorrent_Session_T"));
  ...
  if (inputHandler_)
  {
    ...
    //         (see ACE_Event_Handler.cpp:252, BitTorrent_client_inputhandler.cpp:107)
    ...
    if (result == -1)
      ACE_DEBUG ((LM_ERROR,
                  ACE_TEXT ("failed to BitTorrent_Client_InputHandler::handle_close(): \"%m\", continuing\n")));
...
{
  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Session_T::start"));

  ACE_UNUSED_ARG (sessionData_in);
  int result = -1;

  // step0a: retrieve controller handle
  const BitTorrent_Stream_t& stream_r = inherited::stream ();
  ...
  for (typename inherited::CONNECTION_BASE_T::STREAM_T::ITERATOR_T iterator (stream_r);
    ...
    if (ACE_OS::strcmp (module_p->name (),
                        ACE_TEXT_ALWAYS_CHAR (BITTORRENT_CLIENT_HANDLER_MODULE_NAME)) == 0)
      break;
  if (!module_p)
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("module \"%s\" not found, returning\n"),
                ACE_TEXT (BITTORRENT_CLIENT_HANDLER_MODULE_NAME)));
  ...
  inherited::state_.controller =
    dynamic_cast<BitTorrent_IControl_t*> (const_cast<typename inherited::CONNECTION_BASE_T::STREAM_T::MODULE_T*> (module_p)->writer ());
  if (!inherited::state_.controller)
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("%s: dynamic_cast<BitTorrent_Client_IControl_t*> failed, returning\n"),
  ...
  //{
  //  const BitTorrent_Client_Configuration& configuration_r = inherited::get ();
  //  configuration_p = &const_cast<BitTorrent_Client_Configuration&> (configuration_r);
  //} // end IF
  //else
  ...
  if (logToFile_)
  {
    ...
    file_name +=
        ACE_TEXT_ALWAYS_CHAR (BITTORRENT_CLIENT_SESSION_LOG_FILENAME_PREFIX);
      ...
      !inputHandler_)
  {
    ...
    {
      ACE_DEBUG ((LM_ERROR,
                  ACE_TEXT ("failed to BitTorrent_Client_InputHandler::initialize(): \"%m\", returning\n")));
...
//template <typename ConnectionType>
//const BitTorrent_Client_ConnectionState&
//BitTorrent_Session_T<ConnectionType>::state () const
//{
//  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Session_T::state"));
//
...
BitTorrent_Session_T<ConnectionType,
              ...
              InputHandlerType,
              InputHandlerConfigurationType,
              LogOutputType>::notify (const BitTorrent_Record& message_in)
{
  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Session_T::notify"));

  switch (message_in.command.discriminator)
  {
    case BitTorrent_Record::Command::NUMERIC:
    {
      switch (message_in.command.numeric)
      {
        case BitTorrent_Codes::RPL_WELCOME:          //   1
        {
          // *NOTE*: this is the first message in any connection !

          // *WARNING*: falls through !
        }
        case BitTorrent_Codes::RPL_YOURHOST:         //   2
        case BitTorrent_Codes::RPL_CREATED:          //   3
        case BitTorrent_Codes::RPL_MYINFO:           //   4
        case BitTorrent_Codes::RPL_PROTOCTL:         //   5
        case BitTorrent_Codes::RPL_SNOMASK:          //   8
        case BitTorrent_Codes::RPL_YOURID:           //  42
        case BitTorrent_Codes::RPL_STATSDLINE:       // 250
        case BitTorrent_Codes::RPL_LUSERCLIENT:      // 251
        case BitTorrent_Codes::RPL_LUSEROP:          // 252
        case BitTorrent_Codes::RPL_LUSERUNKNOWN:     // 253
        case BitTorrent_Codes::RPL_LUSERCHANNELS:    // 254
        case BitTorrent_Codes::RPL_LUSERME:          // 255
        case BitTorrent_Codes::RPL_TRYAGAIN:         // 263
        case BitTorrent_Codes::RPL_LOCALUSERS:       // 265
        case BitTorrent_Codes::RPL_GLOBALUSERS:      // 266
        case BitTorrent_Codes::RPL_INVITING:         // 341
        {
          log (message_in);
          break;
        }
        case BitTorrent_Codes::RPL_USERHOST:         // 302
        {
        ...
        case BitTorrent_Codes::RPL_UNAWAY:           // 305
        {
          log (message_in);

          break;
        }
        case BitTorrent_Codes::RPL_NOWAWAY:          // 306
        {
          log (message_in);

          break;
        }
        case BitTorrent_Codes::RPL_ENDOFWHO:         // 315
        {
          log (message_in);
        ...
        case BitTorrent_Codes::RPL_LISTSTART:        // 321
        {
          // *WARNING*: falls through !
        }
        case BitTorrent_Codes::RPL_LISTEND:          // 323
        {
          log (message_in);

          break;
        }
        case BitTorrent_Codes::RPL_LIST:             // 322
        {
          // convert <# visible>
          BitTorrent_ParametersIterator_t param_iterator = message_in.params.begin ();
        ...
        case BitTorrent_Codes::RPL_NOTOPIC:          // 331
        case BitTorrent_Codes::RPL_TOPIC:            // 332
        case BitTorrent_Codes::RPL_TOPICWHOTIME:     // 333
          break;
        case BitTorrent_Codes::RPL_WHOREPLY:         // 352
        {
          // bisect user information from parameter strings
          BitTorrent_ParametersIterator_t iterator_2 =
        ...
        case BitTorrent_Codes::RPL_NAMREPLY:         // 353
        {
...
//          bool is_operator = false;
          ...
          BitTorrent_ParametersIterator_t param_iterator =
            message_in.params.begin ();
          ACE_ASSERT (message_in.params.size () >= 3);
          std::advance (param_iterator, 2);
        ...
        case BitTorrent_Codes::RPL_ENDOFNAMES:       // 366
        {
          // retrieve channel name
          BitTorrent_ParametersIterator_t param_iterator =
            message_in.params.begin ();
        ...
        case BitTorrent_Codes::RPL_ENDOFBANLIST:     // 368
        case BitTorrent_Codes::RPL_MOTD:             // 372
        case BitTorrent_Codes::RPL_MOTDSTART:        // 375
        case BitTorrent_Codes::RPL_ENDOFMOTD:        // 376
        case BitTorrent_Codes::RPL_HOSTHIDDEN:       // 396
        case BitTorrent_Codes::ERR_NOSUCHNICK:       // 401
        case BitTorrent_Codes::ERR_UNKNOWNCOMMAND:   // 421
        case BitTorrent_Codes::ERR_NOMOTD:           // 422
        case BitTorrent_Codes::ERR_ERRONEUSNICKNAME: // 432
        case BitTorrent_Codes::ERR_NICKNAMEINUSE:    // 433
        case BitTorrent_Codes::ERR_NOTREGISTERED:    // 451
        case BitTorrent_Codes::ERR_NEEDMOREPARAMS:   // 461
        case BitTorrent_Codes::ERR_ALREADYREGISTRED: // 462
        case BitTorrent_Codes::ERR_YOUREBANNEDCREEP: // 465
        case BitTorrent_Codes::ERR_BADCHANNAME:      // 479
        case BitTorrent_Codes::ERR_CHANOPRIVSNEEDED: // 482
        case BitTorrent_Codes::ERR_UMODEUNKNOWNFLAG: // 501
        {
          log (message_in);

          if ((message_in.command.numeric == BitTorrent_Codes::ERR_NOSUCHNICK)       ||
              (message_in.command.numeric == BitTorrent_Codes::ERR_UNKNOWNCOMMAND)   ||
              (message_in.command.numeric == BitTorrent_Codes::ERR_ERRONEUSNICKNAME) ||
              (message_in.command.numeric == BitTorrent_Codes::ERR_NICKNAMEINUSE)    ||
              (message_in.command.numeric == BitTorrent_Codes::ERR_NOTREGISTERED)    ||
              (message_in.command.numeric == BitTorrent_Codes::ERR_ALREADYREGISTRED) ||
              (message_in.command.numeric == BitTorrent_Codes::ERR_YOUREBANNEDCREEP) ||
              (message_in.command.numeric == BitTorrent_Codes::ERR_BADCHANNAME)      ||
              (message_in.command.numeric == BitTorrent_Codes::ERR_CHANOPRIVSNEEDED) ||
              (message_in.command.numeric == BitTorrent_Codes::ERR_UMODEUNKNOWNFLAG))
        ...
        default:
        {
          ACE_DEBUG ((LM_WARNING,
                      ...
                      ACE_TEXT (BitTorrent_Tools::Command2String (message_in.command.numeric).c_str ()),
    ...
    case BitTorrent_Record::Command::STRING:
    {
      BitTorrent_Record::CommandType command =
        BitTorrent_Tools::Command2Type (*message_in.command.string);
      switch (command)
      {
        case BitTorrent_Record::NICK:
        {
        ...
        case BitTorrent_Record::USER:
        case BitTorrent_Record::QUIT:
        {
          log (message_in);

          if ((message_in.prefix.origin == inherited::state_.nickName) &&
              (command == BitTorrent_Record::QUIT))
            error (message_in); // --> show on statusbar as well

          break;
        }
        case BitTorrent_Record::JOIN:
        {
        ...
        case BitTorrent_Record::MODE:
        {
          ...
          {
            // --> user mode
            BitTorrent_Tools::merge (message_in.params.back (),
                              inherited::state_.userModes);
          } // end IF
          else
          {
            // --> channel mode
            BitTorrent_Tools::merge (*param_iterator,
                              inherited::state_.channelModes);
          } // end ELSE

          break;
        }
        case BitTorrent_Record::TOPIC:
        {
          log (message_in);
          break;
        }
        case BitTorrent_Record::KICK:
        {
          log (message_in);
        ...
        case BitTorrent_Record::PRIVMSG:
        {
...
//          std::string target_id;
        ...
        case BitTorrent_Record::NOTICE:
#if defined (ACE_WIN32) || defined (ACE_WIN64)
        case BitTorrent_Record::__QUIRK__ERROR:
#else
        case BitTorrent_Record::ERROR:
#endif
        case BitTorrent_Record::AWAY:
        {
          log (message_in);

#if defined (ACE_WIN32) || defined (ACE_WIN64)
          if (command == BitTorrent_Record::__QUIRK__ERROR)
#else
          if (command == BitTorrent_Record::ERROR)
#endif
            error (message_in); // --> show on statusbar as well...

          break;
        }
        case BitTorrent_Record::PING:
          break;
        default:
        {
          ACE_DEBUG ((LM_WARNING,
                      ACE_TEXT ("invalid/unknown command (was: \"%s\"), continuing\n"),
                      ACE_TEXT (message_in.type.string->c_str ())));
...
BitTorrent_Session_T<ConnectionType,
              ...
              InputHandlerType,
              InputHandlerConfigurationType,
              LogOutputType>::notify (const SessionMessageType& sessionMessage_in)
{
  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Session_T::notify"));

//  BitTorrent_Client_GTK_Event event =
...
BitTorrent_Session_T<ConnectionType,
              ...
              LogOutputType>::end ()
{
  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Session_T::end"));
...
{
  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Session_T::open"));
...
//  const BitTorrent_ConnectionState& connection_state_r = inherited::state ();
//  module_handler_configuration_p->userData->connectionState =
//      &const_cast<BitTorrent_ConnectionState&> (connection_state_r);
...
//    // *NOTE*: client-side: arg_in is a handle to the connector
//    //         server-side: arg_in is a handle to the listener
//    const BitTorrent_Client_SocketHandlerConfiguration* handler_configuration_p = NULL;
...
//  else
  ...
  module_handler_configuration_p->subscriber = this;
//  ACE_ASSERT (module_handler_configuration_p->userData);
//  const BitTorrent_Client_ConnectionState& connection_state_r = inherited::state ();
//  module_handler_configuration_p->userData->connectionState =
//      &const_cast<BitTorrent_Client_ConnectionState&> (connection_state_r);
...
BitTorrent_Session_T<ConnectionType,
              ...
              InputHandlerType,
              InputHandlerConfigurationType,
              LogOutputType>::error (const BitTorrent_Record& message_in)
{
  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Session_T::error"));

  std::string message_text = BitTorrent_Tools::Record2String (message_in);
  ACE_DEBUG ((LM_DEBUG,
                                   ...
                                   const std::string& messageText_in)
{
  ...
  if (result == -1)
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to BitTorrent_Client_IOStream_t::sync(): \"%m\", continuing\n")));
}
...
BitTorrent_Session_T<ConnectionType,
              ...
              InputHandlerType,
              InputHandlerConfigurationType,
              LogOutputType>::log (const BitTorrent_Record& message_in)
{
  NETWORK_TRACE (ACE_TEXT ("BitTorrent_Session_T::log"));
