 ...
 , trackerStreamHandler_ (this)
{
  ...
  ACE_NEW_NORETURN (peerHandlerModule_,
                    BitTorrent_PeerHandler_Module (ACE_TEXT_ALWAYS_CHAR (BITTORRENT_DEFAULT_HANDLER_MODULE_NAME),
                                                   NULL,
                                                   false));
  ...
  ACE_NEW_NORETURN (trackerHandlerModule_,
                    BitTorrent_TrackerHandler_Module (ACE_TEXT_ALWAYS_CHAR (BITTORRENT_DEFAULT_HANDLER_MODULE_NAME),
                                                      NULL,
                                                      false));
