...
#define BITTORRENT_DEFAULT_ALLOW_MULTIPLE_CONNECTIONS_PER_PEER false
#define BITTORRENT_DEFAULT_REQUEST_COMPACT_PEER_ADDRESSES      true
#define BITTORRENT_DEFAULT_SEND_BITFIELD_AFTER_PEER_HANDSHAKE  true
#define BITTORRENT_DEFAULT_MAX_CONNECTIONS_PER_PEER        5
...
#define BITTORRENT_TRACKER_RESPONSE_PEERS_IP_HEADER        "ip"
#define BITTORRENT_TRACKER_RESPONSE_PEERS_PORT_HEADER      "port"
