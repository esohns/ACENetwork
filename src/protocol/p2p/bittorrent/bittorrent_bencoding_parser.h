...
namespace yy {
  ...
  Bencoding_Dictionary_t* dval;
    ...
    struct basic_symbol : Base
    {
      ...
      {
        return BitTorrent_Bencoding_Parser::symbol_name (this->kind ());
      }
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    BitTorrent_Bencoding_Parser (const BitTorrent_Bencoding_Parser&) = delete;
    /// Non copyable.
    BitTorrent_Bencoding_Parser& operator= (const BitTorrent_Bencoding_Parser&) = delete;
#endif
    ...
    {
    public:
      context (const BitTorrent_Bencoding_Parser& yyparser, const symbol_type& yyla);
    ...
    private:
      const BitTorrent_Bencoding_Parser& yyparser_;
