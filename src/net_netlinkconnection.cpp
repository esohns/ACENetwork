...
////Net_AsynchNetlinkConnection::Net_AsynchNetlinkConnection (Net_IConnectionManager_t* interfaceHandle_in)
//// : inherited (interfaceHandle_in)
////{
////  NETWORK_TRACE (ACE_TEXT ("Net_AsynchNetlinkConnection::Net_AsynchNetlinkConnection"));
////
...
////int
////Net_AsynchNetlinkConnection::open (void* arg_in)
////{
...
////
////int
////Net_AsynchNetlinkConnection::close (u_long arg_in)
////{
////  NETWORK_TRACE (ACE_TEXT ("Net_AsynchNetlinkConnection::close"));
////  // [*NOTE*: hereby we override the default behavior of a ACE_Svc_Handler,
////  // which would call handle_close() AGAIN]
////
////  // *NOTE*: this method will be invoked
