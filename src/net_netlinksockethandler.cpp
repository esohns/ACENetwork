...
Net_NetlinkSocketHandler::Net_NetlinkSocketHandler ()//MANAGER_T* manager_in)
...
// , isRegistered_ (false)
{
  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::Net_NetlinkSocketHandler"));
...
Net_NetlinkSocketHandler::~Net_NetlinkSocketHandler ()
{
  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::~Net_NetlinkSocketHandler"));
...
//Net_NetlinkSocketHandler::add_reference (void)
//{
//  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::add_reference"));
//
//  inherited::increase ();
//
...
//ACE_Event_Handler::Reference_Count
//Net_NetlinkSocketHandler::remove_reference (void)
//{
//  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::remove_reference"));
//
...
int
Net_NetlinkSocketHandler::open (void* arg_in)
{
  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::open"));
...
{
  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::handle_close"));
...
//{
//  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::info"));
...
//{
//  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::close"));
...
//{
//  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::id"));
...
//void
//Net_NetlinkSocketHandler::increase ()
//{
//  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::increase"));
//
//  inherited2::increase ();
...
//
//void
//Net_NetlinkSocketHandler::decrease ()
//{
//  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::decrease"));
//
//  // *NOTE*: may "delete this"
//  inherited2::decrease ();
//  //// *NOTE*: may "delete this"
...
//{
//  NETWORK_TRACE (ACE_TEXT ("Net_NetlinkSocketHandler::dump_state"));
//
//  ACE_TCHAR buffer[BUFSIZ];
//  ACE_OS::memset (buffer, 0, sizeof (buffer));
