...
//  result =
//    (unlikely (inherited2::configuration_->useThreadPerConnection) ? inherited::getq (writeBuffer_, NULL)
...
//      ACE_DEBUG ((LM_ERROR,
//                  (inherited2::configuration_->useThreadPerConnection ? ACE_TEXT ("%u: failed to ACE_Task::getq(): \"%m\", aborting\n")
