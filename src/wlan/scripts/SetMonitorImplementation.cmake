...
endif (NOT DEFINED MONITOR_IMPLEMENTATION_LAST)
if (NOT (${MONITOR_IMPLEMENTATION} STREQUAL ${MONITOR_IMPLEMENTATION_LAST}))
 if (UNIX)
...
endif (NOT (${MONITOR_IMPLEMENTATION} STREQUAL ${MONITOR_IMPLEMENTATION_LAST}))

if (UNIX)
 if (${MONITOR_IMPLEMENTATION} MATCHES "Wext")
  if (NOT WEXT_SUPPORT)
   message (FATAL_ERROR "wext not supported")
  endif (NOT WEXT_SUPPORT)
