...
#endif // ACE_WIN32 || ACE_WIN64
{
 ...
 private:
  ...
  inline virtual const ACE_MT_SYNCH::MUTEX& getR_2 () const { static ACE_MT_SYNCH::MUTEX dummy; return dummy; }
...
//  using inherited::getR_2;
  ...
  inline virtual void report () const { ACE_NOTSUP; ACE_NOTREACHED (return;) }
