         ...
         iterator_2++)
    {
      ...
      switch (*iterator_2)
      {
        case TEST_U_GTKEVENT_CONNECT:
        {
          spin_button_p =
              GTK_SPIN_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                       ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_SPINBUTTON_NUMCONNECTIONS_NAME)));
          ACE_ASSERT (spin_button_p);
          ...
          spin_button_p =
              GTK_SPIN_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                       ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_SPINBUTTON_NUMSESSIONMESSAGES_NAME)));
          ACE_ASSERT (spin_button_p);
        ...
        case TEST_U_GTKEVENT_DATA:
        {
          spin_button_p =
              GTK_SPIN_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                       ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_SPINBUTTON_DATA_NAME)));
          ACE_ASSERT (spin_button_p);
          ...
          spin_button_p =
              GTK_SPIN_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                       ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_SPINBUTTON_NUMMESSAGES_NAME)));
          ACE_ASSERT (spin_button_p);
...
idle_initialize_ui_cb (gpointer userData_in)
{
  ...
  spin_button_p =
    GTK_SPIN_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                             ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_SPINBUTTON_PORT_NAME)));
  ACE_ASSERT (spin_button_p);
  gtk_spin_button_set_range (spin_button_p,
                             0.0,
                             std::numeric_limits<double>::max ());
  ...
  GtkFileChooserButton* file_chooser_button_p =
    GTK_FILE_CHOOSER_BUTTON (gtk_builder_get_object ((*iterator).second.second,
                                                     ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_FILECHOOSERBUTTON_FILE_NAME)));
  ACE_ASSERT (file_chooser_button_p);
  //GError* error_p = NULL;
  //GFile* file_p = NULL;
  gchar* filename_p = NULL;
  WLANMonitor_StreamConfiguration_t::ITERATOR_T iterator_2 =
  ...
  //                          ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_BUTTON_LISTEN_NAME));
  //ACE_ASSERT (object_p);
  //result =
  ...
  //object_p =
  //  gtk_builder_get_object ((*iterator).second.second,
  //    ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_BUTTON_CLOSEALL_NAME));
  //ACE_ASSERT (object_p);
  //result =
  //  g_signal_connect (object_p,
  ...
  //object_p =
  //  gtk_builder_get_object ((*iterator).second.second,
  //    ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_BUTTON_CLEAR_NAME));
  //ACE_ASSERT (object_p);
  //result =
  //  g_signal_connect (object_p,
  //                    ACE_TEXT_ALWAYS_CHAR ("clicked"),
  ...
  //object_p =
  //  gtk_builder_get_object ((*iterator).second.second,
  //                          ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_BUTTON_ABOUT_NAME));
  //ACE_ASSERT (object_p);
  ...
  //object_p =
  //  gtk_builder_get_object ((*iterator).second.second,
  //                          ACE_TEXT_ALWAYS_CHAR (WLAN_MONITOR_GTK_BUTTON_QUIT_NAME));
  //ACE_ASSERT (object_p);
  //result =
  //  g_signal_connect (object_p,
  //                    ACE_TEXT_ALWAYS_CHAR ("clicked"),
                             ...
                             gpointer userData_in)
{
  ...
  WLANMonitor_CONNECTIONMANAGER_SINGLETON::instance ()->abort ();
