...
class Test_U_SignalHandler
 : public Common_SignalHandler_T<struct UPnP_Client_SignalHandlerConfiguration>
{
  typedef Common_SignalHandler_T<struct UPnP_Client_SignalHandlerConfiguration> inherited;
