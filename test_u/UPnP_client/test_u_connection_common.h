...
class UPnP_Client_ConnectionConfiguration;
...
typedef Net_IStreamConnection_T<ACE_INET_Addr,
                                ...
                                enum Stream_StateMachine_ControlState> UPnP_Client_IOutboundStreamConnection_t;
typedef Net_IStreamConnection_T<ACE_INET_Addr,
                                UPnP_Client_ConnectionConfiguration,
                                struct HTTP_ConnectionState,
                                HTTP_Statistic_t,
                                ...
                                enum Stream_StateMachine_ControlState> UPnP_Client_IInboundStreamConnection_t;
...
typedef Net_IConnector_T<ACE_INET_Addr,
                         UPnP_Client_ConnectionConfiguration> UPnP_Client_IConnector_t;
