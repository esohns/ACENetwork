...
typedef Stream_Module_Net_IOWriter_T<ACE_MT_SYNCH,
                                     ...
                                     struct Stream_UserData> UPnP_Client_Module_Net_Writer_t;
typedef Stream_Module_Net_IOReader_T<ACE_MT_SYNCH,
                                     ...
                                     ACE_INET_Addr,
                                     UPnP_Client_ConnectionManager_t,
                                     struct Stream_UserData> UPnP_Client_Module_Net_Reader_t;
...
typedef SSDP_Module_Streamer_T<ACE_MT_SYNCH,
                               ...
                               Stream_ControlMessage_t,
                               Test_U_Message,
                               Test_U_SessionMessage> UPnP_Client_Module_Streamer;
...
DATASTREAM_MODULE_DUPLEX (struct UPnP_Client_SessionData,                  // session data type
                          ...
                          UPnP_Client_Module_Net_Reader_t,                 // reader type
                          UPnP_Client_Module_Net_Writer_t,                 // writer type
                          UPnP_Client_Module_Net_IO);                      // name
...
DATASTREAM_MODULE_OUTPUT_ONLY (struct UPnP_Client_SessionData,                // session data type
                               ...
                               Stream_INotify_t,                             // stream notification interface type
                               UPnP_Client_Module_Streamer);                  // reader type
DATASTREAM_MODULE_DUPLEX (struct UPnP_Client_SessionData,                // session data type
                          enum Stream_SessionMessageType,               // session event type
                          struct UPnP_Client_ModuleHandlerConfiguration, // module handler configuration type
                          ...
                          UPnP_Client_Module_Marshal);                   // name
