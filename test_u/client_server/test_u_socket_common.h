...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
#else
typedef Net_StreamAsynchUDPSocketBase_T<Net_AsynchNetlinkSocketHandler_T<Test_U_SocketHandlerConfiguration>,
                                        Net_SOCK_Netlink,
                                        Net_Netlink_Addr,
                                        Test_U_Configuration,
                                        Test_U_ConnectionState,
                                        ...
                                        Test_U_SocketHandlerConfiguration> Test_U_AsynchNetlinkHandler_t;
#endif
...
typedef Net_StreamAsynchUDPSocketBase_T<Net_AsynchUDPSocketHandler_T<Test_U_SocketHandlerConfiguration>,
                                        ...
                                        Stream_ModuleConfiguration,
                                        Test_U_ModuleHandlerConfiguration,
                                        Test_U_SocketHandlerConfiguration> Test_U_AsynchUDPHandler_t;
typedef Net_StreamAsynchUDPSocketBase_T<Net_AsynchUDPSocketHandler_T<Test_U_SocketHandlerConfiguration>,
                                        ...
                                        Stream_ModuleConfiguration,
                                        Test_U_ModuleHandlerConfiguration,
                                        Test_U_SocketHandlerConfiguration> Test_U_AsynchIPMulticastHandler_t;
typedef Net_StreamAsynchUDPSocketBase_T<Net_AsynchUDPSocketHandler_T<Test_U_SocketHandlerConfiguration>,
                                        ...
                                        Stream_ModuleConfiguration,
                                        Test_U_ModuleHandlerConfiguration,
                                        Test_U_SocketHandlerConfiguration> Test_U_AsynchIPBroadcastHandler_t;
...
#if defined (ACE_WIN32) || defined (ACE_WIN64)
#else
typedef Net_StreamUDPSocketBase_T<Net_NetlinkSocketHandler_T<Test_U_SocketHandlerConfiguration>,
                                  Net_Netlink_Addr,
                                  Test_U_Configuration,
                                  Test_U_ConnectionState,
                                  Net_RuntimeStatistic_t,
                                  ...
                                  Stream_ModuleConfiguration,
                                  Test_U_ModuleHandlerConfiguration,
                                  Test_U_SocketHandlerConfiguration> Test_U_NetlinkHandler_t;
#endif
...
typedef Net_StreamUDPSocketBase_T<Net_UDPSocketHandler_T<Net_SOCK_Dgram,
                                  ...
                                  Stream_ModuleConfiguration,
                                  Test_U_ModuleHandlerConfiguration,
                                  Test_U_SocketHandlerConfiguration> Test_U_UDPHandler_t;
typedef Net_StreamUDPSocketBase_T<Net_UDPSocketHandler_T<ACE_SOCK_DGRAM_MCAST,
                                  ...
                                  Stream_ModuleConfiguration,
                                  Test_U_ModuleHandlerConfiguration,
                                  Test_U_SocketHandlerConfiguration> Test_U_IPMulticastHandler_t;
typedef Net_StreamUDPSocketBase_T<Net_UDPSocketHandler_T<ACE_SOCK_DGRAM_BCAST,
                                  ...
                                  Stream_ModuleConfiguration,
                                  Test_U_ModuleHandlerConfiguration,
                                  Test_U_SocketHandlerConfiguration> Test_U_IPBroadcastHandler_t;
