// -*- C++ -*-
//
// generated by wxGlade 0.8.3 on Tue Mar 19 10:17:09 2019
//
  ...
  wxDialog(parent, id, title, pos, size, wxCAPTION|wxRESIZE_BORDER)
{
  ...
  togglebutton_listen = new wxToggleButton(this, wxID_ANY, wxT("Listen"));
  button_close = new wxButton(this, wxID_CLOSE, wxEmptyString);
  button_report = new wxButton(this, wxID_ANY, wxT("Report"));
...
void dialog_main_base::do_layout()
{
  ...
  wxFlexGridSizer* grid_sizer_1 = new wxFlexGridSizer(0, 2, 0, 0);
...
//  EVT_TOGGLEBUTTON(wxID_ANY, dialog_main_base::togglebutton_listen_cb)
//  EVT_BUTTON(wxID_ANY, dialog_main_base::button_close_cb)
//  EVT_BUTTON(wxID_ANY, dialog_main_base::button_report_cb)
//  EVT_BUTTON(wxID_ANY, dialog_main_base::button_about_cb)
