...
void
Test_U_Module_EventHandler::handleDataMessage (Test_U_Message*& message_inout,
                                               bool& passMessageDownstream_out)
{
  NETWORK_TRACE (ACE_TEXT ("Test_U_Module_EventHandler::handleDataMessage"));
  ...
  if (likely (session_data_r.connection))
